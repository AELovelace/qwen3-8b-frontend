...
To create a basic sequence you add either a sound, a sprite, an object or a font (for text) into the sequence *canvas* and then position it to where you want it to be at the start of the sequence. This creates an **[Asset Track](#)** in the [Track Panel](#) and also adds a **[keyframe](#)** into the [Dope Sheet](#) to show the duration that the asset will be visible for.
