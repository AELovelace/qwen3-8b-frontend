...
The downloaded asset can be imported by dragging it into the GameMaker IDE or using the "**Import Local Package**" option from [The Tools Menu](../../IDE_Navigation/Menus/The_Tools_Menu.md).
