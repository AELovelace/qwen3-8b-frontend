...
| --- | --- | --- |
| bool | [Boolean](../../../GML_Overview/Data_Types.md) | Set double\-click detection on (true) or off (false) |
...
The above code checks to see if the device running the game is a Windows PC or a Mac and if it's either of them, it disables the double tap function.
