...
This function will affect the [check](gamepad_button_check.md), [pressed](gamepad_button_check_pressed.md) and [released](gamepad_button_check_released.md) states for analogue buttons, but will *not* affect the value returned by the function [gamepad\_button\_value()](gamepad_button_value.md), which will always return the raw value for the button.
...
| threshold | [Real](../../../GML_Overview/Data_Types.md) | The new threshold value (from 0 \- 1, default 0\.5\). |
