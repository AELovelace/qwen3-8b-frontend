...
- A string with "no mapping" if there is no mapping set (this is *not* the same as when no mapping is available)
...
| --- | --- | --- |
| index | [Real](../../../GML_Overview/Data_Types.md) | The gamepad index "slot" to get the mapping from |
