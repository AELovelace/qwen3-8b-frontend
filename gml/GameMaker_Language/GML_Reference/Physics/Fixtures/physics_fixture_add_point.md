...
Here is an illustration to help you visualise this process:
...
| xpos | [Real](../../../GML_Overview/Data_Types.md) | the x position of the point (*relative to the fixture origin* for polygon shapes) |
| ypos | [Real](../../../GML_Overview/Data_Types.md) | the y position of the point (*relative to the fixture origin* for polygon shapes) |
