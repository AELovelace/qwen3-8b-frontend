...
Raycast Hitpoint Struct

| Variable | Type | Description |
| --- | --- | --- |
| instance | [Object Instance](../Asset_Management/Instances/Instance_Variables/id.md) | The instance that was hit. |
| hitpointX | [Real](../../GML_Overview/Data_Types.md) | The x coordinate of the hitpoint. |
| hitpointY | [Real](../../GML_Overview/Data_Types.md) | The y coordinate of the hitpoint. |
| normalX | [Real](../../GML_Overview/Data_Types.md) | The x component of the normal at the hitpoint. |
| normalY | [Real](../../GML_Overview/Data_Types.md) | The y component of the normal at the hitpoint. |
| fraction | [Real](../../GML_Overview/Data_Types.md) | The fraction of the line segment where the hit occurred, a value from 0 to 1\. 0 is at the start point, 1 is at the end point, 0\.5 is in the middle, etc. |
...
| --- | --- | --- |
| x\_start | [Real](../../GML_Overview/Data_Types.md) | The x coordinate of the ray's start point. |
| y\_start | [Real](../../GML_Overview/Data_Types.md) | The y coordinate of the ray's start point. |
| x\_end | [Real](../../GML_Overview/Data_Types.md) | The x coordinate of the ray's end point. |
| y\_end | [Real](../../GML_Overview/Data_Types.md) | The y coordinate of the ray's end point. |
| ids | [Object Asset](../../../The_Asset_Editors/Objects.md) or [Object Instance](../Asset_Management/Instances/Instance_Variables/id.md) or [Array](../../GML_Overview/Arrays.md) | A single object asset, instance or an array containing a combination of them to check the ray against. All of them must have physics fixtures. Child objects that have physics enabled are also checked. |
| all\_hits | [Boolean](../../GML_Overview/Data_Types.md) | Whether to return all the hits or only the closest. The default is false. |
| max\_fraction | [Real](../../GML_Overview/Data_Types.md) | The maximum proportion of the ray to check. A value from 0 to 1\. 0 is at the start point, 1 is at the end point. If this is set to, for example, 0\.5 then the check is only performed from the ray's start point to its midpoint. The default is 1, meaning the ray is checked fully. |
...
In the Draw event, the physics world's shapes are drawn with a call to [physics\_world\_draw\_debug](The_Physics_World/physics_world_draw_debug.md) and the ray itself is drawn with a call to [draw\_line\_colour](../Drawing/Basic_Forms/draw_line_colour.md). If physics\_raycast returned undefined, the Draw event is exited. If it returned results, a line is drawn for every hitpoint returned: a line 40 pixels long is drawn from the hitpoint in the direction of the normal at the hitpoint.
