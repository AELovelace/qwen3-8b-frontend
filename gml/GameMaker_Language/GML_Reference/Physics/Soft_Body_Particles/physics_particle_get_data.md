...
| [Physics Particle Data Flag Constant](physics_particle_get_data.md) | | |
| --- | --- | --- |
...
| phy\_particle\_data\_flag\_category | The particle category (as defined when you created the particle or group to which it belongs). | buffer\_u32 |
