...
Apart from the specific functions listed below you can all use an expression (called an *accessor*) to add or modify the contents of your DS grid. This accessor looks similar to a 2D array with the following syntax:
