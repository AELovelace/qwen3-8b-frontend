...
| --- | --- | --- |
| id | [DS Map](ds_map_create.md) | The handle of the DS map to use. |
| key | [String](../../../GML_Overview/Data_Types.md) | The key to replace. |
| value | [DS Map](ds_map_create.md) | The handle of the DS map to use to replace the one previously stored in the given key. |
