...
| --- | --- | --- |
| id | [DS Map](ds_map_create.md) | The handle of the map to add to. |
| key | [String](../../../GML_Overview/Data_Types.md) | The key of the value to add. |
| val | [Any](../../../GML_Overview/Data_Types.md#variable) | The value to add to the map. |
