...
Also see: [string\_split\_ext](string_split_ext.md)
...
| --- | --- | --- |
| string | [String](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The string to split using the given delimiter |
| delimiter | [String](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The delimiter to use |
