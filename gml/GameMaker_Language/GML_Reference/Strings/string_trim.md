...
| --- | --- | --- |
| str | [String](../../GML_Overview/Data_Types.md) | The string to trim |
| substr | [Array](../../GML_Overview/Arrays.md) of [String](../../GML_Overview/Data_Types.md)[s](Strings.md) | An array containing strings to trim from the string |
...
The above code first defines a string literal that contains newlines by prefixing it with the [@](Strings.md#@) character. It assigns the new string to the temporary variable \_string\_from\_literal. This string is then trimmed using string\_trim and the result is stored in a new variable clean\_string.
