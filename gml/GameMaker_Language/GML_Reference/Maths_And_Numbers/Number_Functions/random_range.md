...
| --- | --- | --- |
| n1 | [Real](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The low end of the range from which the random number will be selected. |
| n2 | [Real](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The high end of the range from which the random number will be selected. |
