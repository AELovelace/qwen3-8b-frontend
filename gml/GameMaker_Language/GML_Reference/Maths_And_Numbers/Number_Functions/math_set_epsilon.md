...
The epsilon value will be used for all the following comparison [Operators](../../../GML_Overview/Expressions_And_Operators.md#operators):
...
It is also used by the [sqrt](sqrt.md) function.
  ...
  Setting an epsilon value of 0 will disable all rounding, and using a value of 1 will give an error.
...
| --- | --- | --- |
| epsilon | [Real](../../../GML_Overview/Data_Types.md) | The new epsilon value (from 0 to 0\.999999999\). |
