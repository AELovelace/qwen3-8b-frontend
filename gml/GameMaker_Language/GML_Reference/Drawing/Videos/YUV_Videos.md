     ...
     {  
         ...
         case video\_format\_yuv:  
             ...
             {  
                 ...
                 var \_texfilter \= gpu\_get\_texfilter();  
                 ...
                 gpu\_set\_texfilter(\_texfilter);  
...
- Makes sure that they exist, using [surface\_exists()](../Surfaces/surface_exists.md)
	...
	- Stores the current [texture filtering](../GPU_Control/gpu_set_texfilter.md) setting and disables it
		- Begins drawing a triangle strip primitive, with the video surface's texture assigned to it
		- Draws a rectangle made of two triangles (i.e. a quad) to cover the video surface, using the width and height of the chroma surface for the quad
		- Ends the primitive, drawing it
	- Restores the previous texture filtering setting and resets the shader
