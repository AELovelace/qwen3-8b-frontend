...
There are asynchronous callbacks associated with video playback. See [Async Callbacks](Videos.md#h) for more information.
...
| --- | --- | --- |
| path | [String](../../../GML_Overview/Data_Types.md) | Path to the video file or a [constraints object](https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia#constraints) for a camera feed on GX.games |
