...
| --- | --- | --- |
| groupname | [String](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The name of the Texture Group as a string. These are defined in the [Texture Groups](../../../../Settings/Texture_Groups.md) window. |
| prefetch | [Boolean](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | If true (default), the group is decompressed and fetched into VRAM. If false, it's only loaded into RAM, remaining compressed. |
