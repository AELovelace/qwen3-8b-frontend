...
| --- | --- | --- |
| ps | [Particle System ID](GameMaker_Language/GML_Reference/Drawing/Particles/Particle_Systems/part_system_create.md) | The index of the particle system the emitter belongs to |
...
| enable | [Boolean](GameMaker_Language/GML_Overview/Data_Types.md) | Whether to enable or disable relative mode for the emitter |
