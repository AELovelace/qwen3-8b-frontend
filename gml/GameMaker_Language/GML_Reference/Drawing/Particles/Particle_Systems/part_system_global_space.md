...
Once enabled, you can move and rotate your particle systems with [part\_system\_position](part_system_position.md) and [part\_system\_angle](part_system_angle.md) respectively, without moving the individual particles inside them.
...
| --- | --- | --- |
| ind | [Particle System ID](GameMaker_Language/GML_Reference/Drawing/Particles/Particle_Systems/part_system_create.md) | The index of the particle system |
| enable | [Boolean](GameMaker_Language/GML_Overview/Data_Types.md) | Whether to enable or disable global space particles |
