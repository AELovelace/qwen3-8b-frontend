...
| --- | --- | --- |
| layer | [String](../../../../GML_Overview/Data_Types.md) or [Layer](../../../Asset_Management/Rooms/General_Layer_Functions/layer_get_id.md) | The layer ID (or name) to assign the particle system to (can be any layer type) |
| persistent | [Boolean](../../../../GML_Overview/Data_Types.md) | Flag the particle system as persistent (set to true) or not (set to false) |
