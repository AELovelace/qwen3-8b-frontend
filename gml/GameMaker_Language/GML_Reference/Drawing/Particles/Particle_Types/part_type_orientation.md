...
| --- | --- | --- |
| ind | [Particle Type](part_type_create.md) | The index of the particle type to change. |
| ang\_min | [Real](../../../../GML_Overview/Data_Types.md) | The minimum starting angle of the particles. |
| ang\_max | [Real](../../../../GML_Overview/Data_Types.md) | The maximum starting angle of the particles. |
| ang\_incr | [Real](../../../../GML_Overview/Data_Types.md) | The increase (or decrease if set negative) of the angle in degrees per step. |
| ang\_wiggle | [Real](../../../../GML_Overview/Data_Types.md) | The amount the angle wiggles clockwise/counterclockwise per step. |
| ang\_relative | [Boolean](../../../../GML_Overview/Data_Types.md) | Whether to set its angle relative to the direction of the particle's motion (true) or not (false). |
