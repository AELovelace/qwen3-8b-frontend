...
| dir\_min | [Real](../../../../GML_Overview/Data_Types.md) | The minimum direction the particle can start at. |
| dir\_max | [Real](../../../../GML_Overview/Data_Types.md) | The maximum direction the particle can start at. |
| dir\_incr | [Real](../../../../GML_Overview/Data_Types.md) | How much the particle direction should increase or decrease per step. |
| dir\_wiggle | [Real](../../../../GML_Overview/Data_Types.md) | How much should randomly be added or subtracted from the particle's direction per step. |
