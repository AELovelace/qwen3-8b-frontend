...
| --- | --- | --- |
| ind | [Particle Type ID](GameMaker_Language/GML_Reference/Drawing/Particles/Particle_Types/part_type_create.md) | The index of the particle type |
| subimg | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The sub\-image (frame) to use |
