...
This function sets a range for the starting size of the given particle type on the X axis, and how it changes over its lifetime.
  ...
  If the size must be the same on both axes, use [part\_type\_size](part_type_size.md) instead.
...
| --- | --- | --- |
| ind | [Particle Type ID](GameMaker_Language/GML_Reference/Drawing/Particles/Particle_Types/part_type_create.md) | The particle type index |
| size\_min\_x | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The minimum size along the x axis that particles of this type can be created with |
| size\_max\_x | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The maximum size along the x axis that particles of this type can be created with |
| size\_incr\_x | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The size along the x axis to add every step |
| size\_wiggle\_x | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The "wiggle" value; the maximum random value that can be added every step |
