...
| xtex | [Real](../../../GML_Overview/Data_Types.md) | The x coordinate within the texture (0 refers to the left edge of the sprite image, 1 refers to the right edge). |
| ytex | [Real](../../../GML_Overview/Data_Types.md) | The y coordinate within the texture (0 refers the top edge of the sprite image, 1 refers the bottom edge). |
| col | [Colour](../Colour_And_Alpha/Colour_And_Alpha.md) | The colour to blend with the texture at this vertex (\-1 or c\_white for no blending). |
| alpha | [Real](../../../GML_Overview/Data_Types.md) | The alpha to draw this vertex with (a value from 0 \- 1\). |
