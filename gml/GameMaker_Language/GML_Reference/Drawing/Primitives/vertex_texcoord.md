...
You supply the vertex buffer to write the data into as well as the UV position on the texture page to use.
  ...
  To get the UV range of a specific asset on the texture page you can use [sprite\_get\_uvs](../../Asset_Management/Sprites/Sprite_Information/sprite_get_uvs.md), [font\_get\_uvs](../../Asset_Management/Fonts/font_get_uvs.md) and [tileset\_get\_uvs](../../Asset_Management/Tilsets/tileset_get_uvs.md).
...
| u | [Real](../../../GML_Overview/Data_Types.md) | The first texture coordinate on the texture page to use (0 \- 1\). |
| v | [Real](../../../GML_Overview/Data_Types.md) | The second texture coordinate on the texture page to use (0 \- 1\). |
