...
This function updates the contents of a vertex buffer using data in the given buffer.
  ...
  You cannot pass a [frozen](vertex_freeze.md) vertex buffer as the destination buffer.
...
| --- | --- | --- |
| dest\_vbuff | [Vertex Buffer ID](vertex_create_buffer.md) | The vertex buffer to copy to |
| dest\_offset | [Real](../../../GML_Overview/Data_Types.md) | The offset in the destination buffer to start writing the data |
| src\_buffer | [Buffer ID](../../Buffers/buffer_create.md) | The source buffer to copy from |
| src\_offset | [Real](../../../GML_Overview/Data_Types.md) | The offset in bytes in the source buffer to start copying. Defaults to 0\. |
| src\_size | [Real](../../../GML_Overview/Data_Types.md) | The size of the data in bytes to copy from the source buffer. Defaults to \-1\. When \-1 the whole buffer is copied. |
