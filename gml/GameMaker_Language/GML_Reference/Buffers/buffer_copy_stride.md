...
For example, in case of GameMaker's [default vertex format](../../../Additional_Information/Guide_To_Primitives_And_Vertex_Building.md#passthrough_vertex_format) the stride value is 24 (3\*4\+4\*1\+2\*4\). The number of bytes to move from one (x, y, z) position in the buffer to the next is 24, the number of bytes to move from one colour value to the next is also 24, as well as the number of bytes to move from one UV to the next.
...
| --- | --- | --- |
| src\_buffer | [Buffer ID](../../../../GameMaker_Language/GML_Reference/Buffers/buffer_create.md) | The buffer containing the source data |
| src\_offset | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The offset, in bytes, in the source buffer to start copying bytes. When negative, it is subtracted from the buffer size. |
| src\_size | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The size, in bytes, of a single item to copy |
| src\_stride | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The number of bytes between two items. This value can be negative and be set to 0\. |
| src\_count | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The number of items to copy |
| dest\_buffer | [Buffer ID](../../../../GameMaker_Language/GML_Reference/Buffers/buffer_create.md) | The buffer to copy the data to |
| dest\_offset | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The offset, in bytes, in the destination buffer to write the data. This offset can be negative. |
| dest\_stride | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The number of bytes between two items in the destination buffer. This value can be negative. |
