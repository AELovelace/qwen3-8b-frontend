...
- These are some options for PlayStation only. Please refer to [this Wiki article](https://github.com/GameMakerEnterprise/GMS2-Runner-PS5/wiki/Using-Buffers-for-Console-Saving-and-Loading) for information (you'll need to be logged in with your developer access account).

  This function is only valid for PlayStation, Xbox and Nintendo Switch targets. On all the other targets it will do nothing.
...
| --- | --- | --- |
| option | [String](../../GML_Overview/Data_Types.md) | The option to set. |
| value | [Real](../../GML_Overview/Data_Types.md) or [String](../../GML_Overview/Data_Types.md) | The value to set (can be a real or string, depending on the option). |
