...
This function returns the size (in bytes) of the given [Buffer Data Type Constant](buffer_write.md) (listed [here](buffer_write.md)).
...
| --- | --- | --- |
| type | [Buffer Data Type Constant](buffer_write.md) | The type of data to be checked (see the list of constants [here](buffer_read.md)). |
