...
A vertex buffer is a special type of buffer. The vertex format determines what data is written to the buffer and in which order. You don't have to write the values directly, but can call functions such as [vertex\_position\_3d](../Drawing/Primitives/vertex_position_3d.md), [vertex\_colour](../Drawing/Primitives/vertex_colour.md), [vertex\_texcoord](../Drawing/Primitives/vertex_texcoord.md), etc.
...
The following schematic shows how the data in a vertex buffer maps to the data in a buffer, and the other way around: 
  ...
  You can use the function [vertex\_format\_get\_info](../Drawing/Primitives/vertex_format_get_info.md) to get information on how the data of a vertex in a given format is laid out in a buffer.
...
- [vertex\_update\_buffer\_from\_buffer](../Drawing/Primitives/vertex_update_buffer_from_buffer.md)
