...
The most general function is [http\_request](http_request.md), which allows you to specify any request method as well as headers and data.

The other functions can be used for more specific requests:

- [http\_get](http_get.md) for a GET request
- [http\_get\_file](http_get_file.md) to download a file using GET
- [http\_post\_string](http_post_string.md) to make a HTTP request using POST
...
In this example, a **Mouse Left Pressed** event calls the function [http\_request](http_request.md). The request uses the "GET" method to retrieve a webpage. No headers are passed and the request body is set to an empty string "".
...
- [http\_get\_connect\_timeout](http_get_connect_timeout.md)
- [http\_set\_connect\_timeout](http_set_connect_timeout.md)

  The connection timeout isn't implemented on web platforms.
...
- [http\_get\_request\_crossorigin](http_get_request_crossorigin.md)
- [http\_set\_request\_crossorigin](http_set_request_crossorigin.md)
...
- [http\_request](http_request.md)
- [http\_get](http_get.md)
- [http\_get\_file](http_get_file.md)
- [http\_post\_string](http_post_string.md)
