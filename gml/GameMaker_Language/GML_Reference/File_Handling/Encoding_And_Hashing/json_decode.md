...
This function decodes a JSON string and converts it into a [DS Map](../../Data_Structures/DS_Maps/ds_map_create.md), ready for use in GameMaker.
  ...
  This function \- while still valid for DS maps \- has been superseded by the function [json\_parse](json_parse.md) and [structs](../../../GML_Overview/Structs.md), and we recommend that you only use this function for legacy support.
...
| --- | --- | --- |
| string | [String](../../../GML_Overview/Data_Types.md) | The JSON formatted string to decode |
