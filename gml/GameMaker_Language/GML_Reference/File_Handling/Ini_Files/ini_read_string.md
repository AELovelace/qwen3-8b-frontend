...
| --- | --- | --- |
| section | [String](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The section of the .ini to read from. |
| key | [String](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The key within the relevant section of the .ini to read from. |
| default | [String](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The string to return if a string is not found in the defined place (or the .ini file does not exist). Must be a string. |
