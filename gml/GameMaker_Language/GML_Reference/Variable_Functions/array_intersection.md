...
| --- | --- | --- |
| array0 | [Array](../../GML_Overview/Arrays.md) | The first array |
| \[array1, ... array\_n] | [Array](../../GML_Overview/Arrays.md) | Any number of arrays for the intersection (one array per argument) |
