...
The function supports specifying negative values for the index and number of elements, as described under [Offset And Length](Array_Functions.md#offset_and_length).
...
| --- | --- | --- |
| array | [Array](../../../../GameMaker_Language/GML_Overview/Arrays.md) | A reference to an array. |
| index | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The index (position) in the array to delete the value(s) from. Negative indices are supported and count from the end of the array. An offset of \-1 refers to the last element of the array, an offset of \-2 to the one before last element, etc. (see [Offset And Length](Array_Functions.md#offset_and_length)) |
| number | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The number of values to delete. A negative number means elements are deleted backwards, starting at the offset index. E.g. when index is 5, the indices 5, 6 and 7 will be deleted when number is 3, and indices 5, 4 and 3 will be deleted when number is \-3\. (see [Offset And Length](Array_Functions.md#offset_and_length)) |
