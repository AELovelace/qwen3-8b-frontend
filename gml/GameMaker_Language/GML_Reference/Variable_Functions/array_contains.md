...
| value | [Any](../../GML_Overview/Data_Types.md#variable) | The value to look for in the array |
| offset | [Real](../../GML_Overview/Data_Types.md) | The offset, or starting index, in the array. Setting a negative value will count from the end of the array. The starting index will then be array\_length(array) \+ offset. See: [Offset And Length](Array_Functions.md#offset_and_length) |
| length | [Real](../../GML_Overview/Data_Types.md) | The number of elements to traverse. A negative value will traverse the array backwards (i.e. in descending order of indices, e.g. 2, 1, 0 instead of 2, 3, 4\). See: [Offset And Length](Array_Functions.md#offset_and_length) |
