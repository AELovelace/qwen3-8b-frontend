...
// Returns the first dimension of the array  
 ...
 // etc.
  ...
  The function returns 0 in case a data type that's not an [Array](../../GML_Overview/Arrays.md) is passed to it.
...
| --- | --- | --- |
| array | [Array](../../GML_Overview/Arrays.md) | The array to check. |
