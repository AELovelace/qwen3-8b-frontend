...
Finally, you also have the following functions related to variable data types:
  ...
  For more information on data types, please see [Data Types](../../GML_Overview/Data_Types.md), and see here for [Type Tables](../../../Additional_Information/Type_Tables.md).
