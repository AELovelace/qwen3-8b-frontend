...
The function works identically to [array\_shift](array_shift.md), but removes and returns the *last*element instead of the *first*one.

  To only read the last element in the array without removing it, use [array\_last](array_last.md).
...
| --- | --- | --- |
| array | [Array](../../../../GameMaker_Language/GML_Overview/Arrays.md) | The array to remove the last value from. |
