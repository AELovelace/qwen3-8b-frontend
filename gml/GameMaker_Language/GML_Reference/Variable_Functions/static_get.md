...
- **For a method**: Returns the static struct for the function behind the method and **not** the method struct itself (methods are stored as structs, see: [Methods Are Structs](../../GML_Overview/Method_Variables.md#h)).
...
- **For a static struct**: Returns the parent static struct in the [Static Chain](../../GML_Overview/Structs/Static_Structs.md#h). When using constructor inheritance, static structs are chained, i.e. you can get the static struct of a static struct, if the constructor has a parent constructor.
...
| --- | --- | --- |
| struct\_or\_func\_name | [Struct](../../GML_Overview/Structs.md), [Function](../../GML_Overview/Script_Functions.md) or [Method](../../GML_Overview/Method_Variables.md) | The struct, function or method for which to get the static struct |
