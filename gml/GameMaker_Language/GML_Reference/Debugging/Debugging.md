...
- [The Debug Overlay](The_Debug_Overlay.md), an in\-game overlay where you can view the **FPS**, **Log** and **Audio** windows, as well as create your own [custom debug views](The_Debug_Overlay.md#creating_debug_views).

  Although these functions may work on certain platforms they are not to be used for anything other than debugging.

  You can find further information on how to debug your game in the section on [The Debugger](../../../IDE_Tools/The_Debugger.md).
...
The following functions allow you to record various types of input received by your game and play it back for testing purposes.
  ...
  These functions are meant for debugging purposes only and should not be used in a final game.

- [debug\_input\_record](debug_input_record.md)
- [debug\_input\_save](debug_input_save.md)
- [debug\_input\_playback](debug_input_playback.md)
...
- \_GMLINE\_ \- This is the line number as shown in [The Script Editor](../../../The_Asset_Editors/Scripts.md) (you can enable these in the [Code Editor](../../../Setting_Up_And_Version_Information/IDE_Preferences/Text_Editor_Preferences.md#h) preferences).
- \_GMFILE\_ \- This is the name of the current code file this macro is used in. This will look like e.g. "gml\_GlobalScript\_Script1" for a [Script Asset](../../../The_Asset_Editors/Scripts.md), "gml\_Object\_Object1\_Create\_0" for [Object Events](../../../The_Asset_Editors/Object_Properties/Object_Events.md) and "gml\_Room\_Room1\_Create" for the [Room\_Creation\_Code](../../../The_Asset_Editors/Room_Properties/Room_Properties.md#Room_Creation_Code).
...
For example, say you have the following code in a Script:
...
The example below shows the output of the following code placed inside an Object Instance's Create event:

my\_method \= function() {  

     show\_debug\_message(\_GMFILE\_);  

     show\_debug\_message(\_GMLINE\_);  

     show\_debug\_message(\_GMFUNCTION\_);  
...
gml\_Object\_Object1\_Create\_0  

 3  

 gml\_Script\_anon@12@gml\_Object\_Object1\_Create\_0  
