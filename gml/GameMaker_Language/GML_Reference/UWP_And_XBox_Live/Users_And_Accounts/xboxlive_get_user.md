...
| --- | --- | --- |
| index | [Real](../../../../../LINKGOESHERE) | The index (an integer) to get the User ID from. |

 

#### Returns:

[Xbox User ID](../../../../../GameMaker_Language/GML_Reference/UWP_And_XBox_Live/Users_And_Accounts/xboxlive_get_user.md) or [pointer\_null](../../../../../LINKGOESHERE)
