...
| [Xbox Live Achievement Filter Constant](xboxlive_achievement_load_leaderboard.md) | |
| --- | --- |
| Constant | Description |
| xboxlive\_achievement\_filter\_friends\_only | Get only the scores of the players friends. |
| xboxlive\_achievement\_filter\_all\_players | Get all scores for all players. |
...
| --- | --- | --- |
| ident | [String](../../../GML_Overview/Data_Types.md) | The unique ID of the leaderboard as shown on the developer dashboard. |
| minindex | [Real](../../../GML_Overview/Data_Types.md) | The starting index value to get the leaderboard data from. |
| maxindex | [Real](../../../GML_Overview/Data_Types.md) | The maximum index value to get the leaderboard data from. |
| filter | [Xbox Live Achievement Filter Constant](xboxlive_achievement_load_leaderboard.md) | Whether to filter the results to those that are on your friends list or to all players (see the **Description** above) |
