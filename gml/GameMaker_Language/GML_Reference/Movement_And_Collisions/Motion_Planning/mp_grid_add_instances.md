...
| --- | --- | --- |
| id | MP Grid ID | Index of the mp\_grid that is to be used |
| obj | Object Asset or Instance ID | Object index, or instance id, of the instances to be added into the mp\_grid |
