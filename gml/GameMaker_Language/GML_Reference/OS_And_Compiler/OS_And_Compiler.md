...
- [clipboard\_get\_text](../Strings/clipboard_get_text.md)
...
Finally, when working with [Extensions](../../../The_Asset_Editors/Extensions.md) you may need to be able to define and call external functions at runtime, and so you'd use the following:
  ...
  These are legacy functions and you should define any extension functions within the Extension Editor itself.

  These functions are for the **Windows** and **macOS** target platforms only.
