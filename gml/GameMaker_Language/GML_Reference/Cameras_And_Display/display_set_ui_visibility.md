...
- **Android**: You can supply one or more system *flags* as an integer value. When using more than a single flag, these need to be merged using the bitwise "or", as shown in the example below. You can find a list of Android system flags [here](https://developer.android.com/reference/android/view/View#SYSTEM_UI_FLAG_FULLSCREEN).
...
| Argument | Type | flags |
| --- | --- | --- |
| flags | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The system flags to use (an integer value). |
