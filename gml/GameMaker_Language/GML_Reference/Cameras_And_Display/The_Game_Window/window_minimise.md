...
This function minimises the game window. You can restore it with [window\_restore](window_restore.md).
  ...
  This is only supported on Windows, macOS and Linux. On macOS the game will not restore with [window\_restore](window_restore.md) as execution is paused in minimised state.
