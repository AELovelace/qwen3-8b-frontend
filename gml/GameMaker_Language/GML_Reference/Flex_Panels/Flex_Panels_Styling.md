...
The Flex Panel system is used for [UI Layers](../../../The_Asset_Editors/Room_Properties/UI_Layers.md) in the Room Editor. For more visual documentation on the shared properties, see: [UI Element Properties](../../../The_Asset_Editors/Room_Properties/UI_Element_Propert.md)
...
Structs retrieved for nodes (e.g. [flexpanel\_node\_get\_child](Function_Reference/flexpanel_node_get_child.md) or [layer\_get\_flexpanel\_node](../Asset_Management/Rooms/UI_Layers/layer_get_flexpanel_node.md)) using [flexpanel\_node\_get\_struct](Function_Reference/flexpanel_node_get_struct.md) will include the same variables listed below.
...
The sections below describe what type of values you can pass for each property.
  ...
  Each property also has GML functions for setting and getting that property for a node. However, the types of values that a setter function accepts may be different from the type of value you can give it in the struct/JSON. Ensure you read the page for the function you are trying to use for information on its argument types.
...
Struct property: data  
 ...
 Function: [flexpanel\_node\_get\_data](Function_Reference/flexpanel_node_get_data.md)
...
## Styling Properties
  ...
  You can also refer to [Yoga's styling documentation](https://www.yogalayout.dev/docs/styling/) for information beyond what this page describes.

### Width and Height

Struct properties: width, height  

 Functions: [flexpanel\_node\_style\_set\_width](Function_Reference/Styling_Functions/flexpanel_node_style_set_width.md), [flexpanel\_node\_style\_set\_height](Function_Reference/Styling_Functions/flexpanel_node_style_set_height.md), [flexpanel\_node\_style\_get\_width](Function_Reference/Styling_Functions/flexpanel_node_style_get_width.md), [flexpanel\_node\_style\_get\_height](Function_Reference/Styling_Functions/flexpanel_node_style_get_height.md)
...
- Percentage value as string, e.g. "50%": This defines the width or height as a percentage of its [Containing Block](Flex_Panels.md#h)'s width or height.

### Min/Max Width and Height

Struct properties: minWidth, maxWidth, minHeight, maxHeight  

 Functions: [flexpanel\_node\_style\_set\_min\_width](Function_Reference/Styling_Functions/flexpanel_node_style_set_min_width.md), [flexpanel\_node\_style\_set\_max\_width](Function_Reference/Styling_Functions/flexpanel_node_style_set_max_width.md), [flexpanel\_node\_style\_set\_min\_height](Function_Reference/Styling_Functions/flexpanel_node_style_set_min_height.md), [flexpanel\_node\_style\_set\_max\_height](Function_Reference/Styling_Functions/flexpanel_node_style_set_max_height.md), [flexpanel\_node\_style\_get\_min\_width](Function_Reference/Styling_Functions/flexpanel_node_style_get_min_width.md), [flexpanel\_node\_style\_get\_max\_width](Function_Reference/Styling_Functions/flexpanel_node_style_get_max_width.md), [flexpanel\_node\_style\_get\_min\_height](Function_Reference/Styling_Functions/flexpanel_node_style_get_min_height.md), [flexpanel\_node\_style\_get\_max\_height](Function_Reference/Styling_Functions/flexpanel_node_style_get_max_height.md)
...
Struct properties: left, right, top, bottom, start, end  
 ...
 Functions: [flexpanel\_node\_style\_set\_position](Function_Reference/Styling_Functions/flexpanel_node_style_set_position.md), [flexpanel\_node\_style\_get\_position](Function_Reference/Styling_Functions/flexpanel_node_style_get_position.md)
...
left and top will always take precedence over right and bottom, respectively. start and end change depending on the [Layout Direction](#direction).
...
- "absolute": This node is removed from the flow of its parent and will not take up space. Inset positions will be relative to the [Containing Block](Flex_Panels.md#h) which may not be its direct parent.
- "static": The node will behave like relative except it will ignore insets and will not form a [Containing Block](Flex_Panels.md#h) for its children.
...
Struct properties: margin, marginInline, marginLeft, marginRight, marginTop, marginBottom, marginStart, marginEnd, marginHorizontal, marginVertical  
 ...
 Functions: [flexpanel\_node\_style\_set\_margin](Function_Reference/Styling_Functions/flexpanel_node_style_set_margin.md), [flexpanel\_node\_style\_get\_margin](Function_Reference/Styling_Functions/flexpanel_node_style_get_margin.md)
...
Struct properties: border, borderLeft, borderRight, borderTop, borderBottom, borderStart, borderEnd, borderHorizontal, borderVertical  
 ...
 Functions: [flexpanel\_node\_style\_set\_border](Function_Reference/Styling_Functions/flexpanel_node_style_set_border.md), [flexpanel\_node\_style\_get\_border](Function_Reference/Styling_Functions/flexpanel_node_style_get_border.md)
...
Struct properties: direction  
 ...
 Functions: [flexpanel\_node\_style\_set\_direction](Function_Reference/Styling_Functions/flexpanel_node_style_set_direction.md), [flexpanel\_node\_style\_get\_direction](Function_Reference/Styling_Functions/flexpanel_node_style_get_direction.md)
...
This can be set for an entire layout tree when [calculating its layout](Function_Reference/flexpanel_calculate_layout.md).

### Flex Direction

Struct properties: flexDirection  

 Functions: [flexpanel\_node\_style\_set\_flex\_direction](Function_Reference/Styling_Functions/flexpanel_node_style_set_flex_direction.md), [flexpanel\_node\_style\_get\_flex\_direction](Function_Reference/Styling_Functions/flexpanel_node_style_get_flex_direction.md)
...
Struct properties: flexGrow  
 ...
 Functions: [flexpanel\_node\_style\_set\_flex\_grow](Function_Reference/Styling_Functions/flexpanel_node_style_set_flex_grow.md), [flexpanel\_node\_style\_get\_flex\_grow](Function_Reference/Styling_Functions/flexpanel_node_style_get_flex_grow.md)
...
Struct properties: flex  
 ...
 Functions: [flexpanel\_node\_style\_set\_flex](Function_Reference/Styling_Functions/flexpanel_node_style_set_flex.md), [flexpanel\_node\_style\_get\_flex](Function_Reference/Styling_Functions/flexpanel_node_style_get_flex.md)
...
Struct properties: alignItems  
 ...
 Functions: [flexpanel\_node\_style\_set\_align\_items](Function_Reference/Styling_Functions/flexpanel_node_style_set_align_items.md), [flexpanel\_node\_style\_get\_align\_items](Function_Reference/Styling_Functions/flexpanel_node_style_get_align_items.md)
...
Struct properties: alignSelf  
 ...
 Functions: [flexpanel\_node\_style\_set\_align\_self](Function_Reference/Styling_Functions/flexpanel_node_style_set_align_self.md), [flexpanel\_node\_style\_get\_align\_self](Function_Reference/Styling_Functions/flexpanel_node_style_get_align_self.md)
...
Struct properties: display  
 ...
 Functions: [flexpanel\_node\_style\_set\_display](Function_Reference/Styling_Functions/flexpanel_node_style_set_display.md), [flexpanel\_node\_style\_get\_display](Function_Reference/Styling_Functions/flexpanel_node_style_get_display.md)
...
Each struct in the array can contain the following properties:
  ...
  The variables described below are **read\-only**. To change the properties of an Asset Element, use the appropriate [layer element functions](../Asset_Management/Rooms/Rooms.md#room_layers_elements).
...
- **Object Instance properties**:
	...
	- instanceVariables (Struct): Contains the Variable Definitions set up for the object, with the variable name as the key and the variable value as the key value. (  You cannot set read\-only variables or the depth as it is controlled by the layer.)
...
- **Sprite properties**:
	...
	- elementId (Element Handle): Element of the sprite in the layer. Can be used with functions for [Sprite Elements](../Asset_Management/Rooms/Sprite_Layers/Sprite_Layers.md)
