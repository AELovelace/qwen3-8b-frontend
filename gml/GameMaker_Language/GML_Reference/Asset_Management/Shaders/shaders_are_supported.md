...
This function will return whether the current target platform supports shaders, returning true if it does, and false if it does not (which would be the case for HTML5 [without WebGL](../../../../Settings/Game_Options/HTML5.md#graphics) and old Android devices).
