...
| --- | --- | --- |
| background\_element\_id | [Background Element ID](layer_background_get_id.md) | The unique ID value of the background element to be destroyed |
