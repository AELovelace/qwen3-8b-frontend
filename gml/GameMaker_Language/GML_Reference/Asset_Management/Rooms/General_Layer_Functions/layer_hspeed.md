...
| --- | --- | --- |
| layer\_id | [String](../../../../GML_Overview/Data_Types.md) or [Layer](layer_get_id.md) | The handle of the layer to set the horizontal speed of |
| hspd | [Real](../../../../GML_Overview/Data_Types.md) | The horizontal speed (in pixels per game frame) to set |
