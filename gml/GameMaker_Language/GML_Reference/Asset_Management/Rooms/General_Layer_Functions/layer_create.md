...
This function is used to create a new layer within the current room.

You supply the depth that the new layer is to occupy and the function returns the layer handle that can then be used to access the layer in further functions.
...
| --- | --- | --- |
| depth | [Real](../../../../GML_Overview/Data_Types.md) | The depth that the layer has to be created at. |
| name | [String](../../../../GML_Overview/Data_Types.md) | OPTIONAL The name to give the layer (a string). |
