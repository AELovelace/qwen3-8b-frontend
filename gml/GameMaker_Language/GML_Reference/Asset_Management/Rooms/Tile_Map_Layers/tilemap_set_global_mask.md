...
This function sets the [Tile Map Bit Mask](Tile_Map_Layers.md#tile_map_bit_mask) for all tile maps in the game.
...
| --- | --- | --- |
| mask | [Real](../../../../GML_Overview/Data_Types.md) | The mask value to use |
