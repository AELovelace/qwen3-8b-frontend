...
| --- | --- | --- |
| tilemap\_element\_id | [Tile Map Element ID](layer_tilemap_get_id.md) | The unique ID value of the tile map element to get the tile\-data of |
| x\_cell | [Real](../../../../GML_Overview/Data_Types.md) | The cell along the x\-axis to get the tile data from |
| y\_cell | [Real](../../../../GML_Overview/Data_Types.md) | The cell along the y\-axis to get the tile data from |
