...
This function is used to change the parameters of a filter/effect. You specify an FX struct (as returned from [fx\_create()](fx_create.md) or [layer\_get\_fx()](layer_get_fx.md)) and a struct containing its parameters (as returned from [fx\_get\_parameters()](fx_get_parameters.md)). This will make your changes visible in the layer that the FX struct is assigned to.
...
| parameter\_struct |  | A struct containing the parameters for the filter/effect |
