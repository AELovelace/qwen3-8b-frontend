...
| --- | --- | --- |
| filter\_or\_effect |  | The FX struct to get the parameter names of |
...
The above code retrieves the FX struct for a layer and gets its parameter names in an array. It then runs a [for](../../../../GML_Overview/Language_Features/for.md) loop on that array and prints each parameter to the output log.
