...
This function changes the Y (vertical) position of the given Text Element. Note that the text's Y position will be offset by the element's [yorigin](layer_text_yorigin.md) value.
...
| y | [Real](../../../../GML_Overview/Data_Types.md) | The Y position of the element |
