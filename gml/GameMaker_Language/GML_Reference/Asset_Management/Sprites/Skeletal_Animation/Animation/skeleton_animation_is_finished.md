...
With this function you can check if the current skeletal animation has finished playing on the given track.
  ...
  This function will always return false if the animation is set to loop ([skeleton\_animation\_is\_looping](skeleton_animation_is_looping.md)), as an animation cannot have finished if it is still looping.
...
| --- | --- | --- |
| **track** | [Real](../../../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The index of the animation track |
