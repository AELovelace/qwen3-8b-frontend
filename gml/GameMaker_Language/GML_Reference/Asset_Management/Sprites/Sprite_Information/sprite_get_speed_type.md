...
| [Sprite Speed Constant](../../../../../../GameMaker_Language/GML_Reference/Asset_Management/Sprites/Sprite_Information/sprite_get_speed_type.md) | |
| --- | --- |
...
You can find out what the speed value used for the sprite animation was using the function [sprite\_get\_speed()](sprite_get_speed.md), and you can set the animation speed *and* type using the function [sprite\_set\_speed()](../Sprite_Manipulation/sprite_set_speed.md).
...
| --- | --- | --- |
| index | [Sprite Asset](../../../../../../The_Asset_Editors/Sprites.md) | The index of the sprite to get the animation type of |

 

#### Returns:

[Sprite Speed Constant](../../../../../../GameMaker_Language/GML_Reference/Asset_Management/Sprites/Sprite_Information/sprite_get_speed_type.md) (see above)
