...
| --- | --- | --- |
| sprite | [Sprite Asset](The_Asset_Editors/Sprites.md) | The index of the sprite to find the texture page entry of. |
| index | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The image index of the sprite. |

 

#### Returns

[Texture Page Entry](GameMaker_Language/GML_Reference/Asset_Management/Sprites/Sprite_Information/sprite_get_tpe.md)
