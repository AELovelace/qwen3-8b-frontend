...
- Call [audio\_emitter\_create](Audio_Emitters/audio_emitter_create.md) (this will also return undefined)
  ...
  This function differs from [audio\_system\_is\_available](audio_system_is_available.md), which reflects the ability to play audio and depends on the state of the Web Audio context. The audio system has to be initialised first before it can be available.
