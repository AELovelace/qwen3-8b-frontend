...
| --- | --- | --- |
| params | [Struct](../../../GML_Overview/Structs.md) | A struct containing the key\-value pairs for each of the parameters that you want to set. The sound key is required and takes a [Sound Asset](../../../../The_Asset_Editors/Sounds.md) as a value. |
