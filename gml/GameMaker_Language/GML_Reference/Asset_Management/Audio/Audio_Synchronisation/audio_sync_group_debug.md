# audio\_sync\_group\_debug

  This function is obsolete, please use [audio\_debug](../audio_debug.md) instead.
...
| --- | --- | --- |
| group\_index | [Audio Sync Group ID](audio_create_sync_group.md) | The group index to debug, or \-1 to switch off the debugging. |
