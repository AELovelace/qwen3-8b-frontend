...
See the section on [Audio Listeners](Audio_Listeners/Audio_Listeners.md) for more information.
...
| --- | --- | --- |
| soundID | [Sound Instance ID](audio_play_sound.md) | The unique ID of the sound to get the mask of |
