...
| --- | --- | --- |
| soundID | [Sound Instance ID](audio_play_sound.md) | The unique ID of the sound to set the mask of |
| mask | [Real](../../../GML_Overview/Data_Types.md) | The bitmask data to set for the sound |
