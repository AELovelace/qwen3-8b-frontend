...
| --- | --- | --- |
| queueIndex | [Audio Queue ID](../../../../../../GameMaker_Language/GML_Reference/Asset_Management/Audio/Audio_Buffers/audio_create_play_queue.md) | The index of the queue to add to. |
| bufferId | [Buffer ID](../../../../../../GameMaker_Language/GML_Reference/Buffers/buffer_create.md) | The buffer to add to the queue. |
| bufferOffset | [Real](../../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The offset within the source buffer to start from. |
| bufferLength | [Real](../../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The length of the buffer (the number of the bytes in the buffer). |
