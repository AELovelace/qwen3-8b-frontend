...
| --- | --- | --- |
| queueFormat | [Buffer Data Type Constant](../../../Buffers/buffer_write.md) | The format of the buffer data to use (buffer\_u8 or buffer\_s16). |
| queueRate | [Real](../../../../GML_Overview/Data_Types.md) | The sample rate of the data in the buffer queue. |
| queueChannels | [Audio Channel Constant](audio_create_buffer_sound.md) | The channels to use from one of the constants listed above. |
