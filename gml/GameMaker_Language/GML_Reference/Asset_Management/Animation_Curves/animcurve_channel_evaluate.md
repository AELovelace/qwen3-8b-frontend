...
| --- | --- | --- |
| channel\_struct | [Animation Curve Channel Struct](animcurve_get_channel.md) | The struct pointer for the channel to evaluate |
| posx | [Real](../../../GML_Overview/Data_Types.md) | The position in time to check (from 0 to 1\) |
