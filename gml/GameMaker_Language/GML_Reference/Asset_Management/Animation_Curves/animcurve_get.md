...
| name | [String](../../../GML_Overview/Data_Types.md) | This is the name of the animation curve. |
| channels | [Array](../../../GML_Overview/Arrays.md) of [Animation Curve Channel Struct](animcurve_get_channel.md)s | This is an array, where each item in the array is a channel struct. |
...
| --- | --- | --- |
| curve\_id | [Animation Curve Asset](../../../../The_Asset_Editors/Animation_Curves.md) | The asset ID (index) of the animation curve to get |
