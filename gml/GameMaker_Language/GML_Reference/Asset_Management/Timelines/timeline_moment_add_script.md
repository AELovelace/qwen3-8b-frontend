...
| --- | --- | --- |
| ind | [Timeline Asset](../../../../../The_Asset_Editors/Timelines.md) | The index of the timeline to add a moment to. |
| step | [Real](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The moment (step) to add to. |
| script | [Script Function](../../../../../GameMaker_Language/GML_Overview/Script_Functions.md) | The index of the script function to add into the moment. |
