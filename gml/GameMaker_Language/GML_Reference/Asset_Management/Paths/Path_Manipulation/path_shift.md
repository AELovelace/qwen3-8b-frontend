...
| --- | --- | --- |
| index | [Path Asset](../../../../../The_Asset_Editors/Paths.md) | The index of the path to change. |
| xshift | [Real](../../../../GML_Overview/Data_Types.md) | The number of horizontal pixels to shift the path. Negative\=left, positive\=right. |
| yshift | [Real](../../../../GML_Overview/Data_Types.md) | The number of vertical pixels to shift the path. Negative\=up, positive\=down. |
