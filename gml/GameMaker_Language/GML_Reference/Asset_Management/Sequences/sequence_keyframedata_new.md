...
With this function you can create a new keyframe data [struct](../../../GML_Overview/Structs.md), supplying the type of track that the keyframe data will be applied to. The type argument can be any one of the [Sequence Track Type Constant](../../../../../GameMaker_Language/GML_Reference/Asset_Management/Sequences/Sequence_Structs/The_Track_Struct.md#type)s [listed on this page](Sequence_Structs/The_Track_Struct.md).
...
| --- | --- | --- |
| type | [Sequence Track Type Constant](../../../../../GameMaker_Language/GML_Reference/Asset_Management/Sequences/Sequence_Structs/The_Track_Struct.md#type) | The type of keyframe data to create. |

 

#### Returns:

[Sequence Keyframe Data Struct](../../../../../GameMaker_Language/GML_Reference/Asset_Management/Sequences/Sequence_Structs/The_Keyframe_Data_Struct.md)
