...
instance\_activate\_object(obj, \[collision\_space])

| Argument | Type | Description |
| --- | --- | --- |
| obj | [Object Asset](../../../../../The_Asset_Editors/Objects.md) or [Object Instance](../Instance_Variables/id.md) | The object or instance to activate (the keyword **all** can also be used). |
