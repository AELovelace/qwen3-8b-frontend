...
With this function you can set the sprite index of a specific object. This means that all instances of this object that are created *after the sprite\_index has been changed* will be created with this new sprite\_index, while instances that are already in the room may not be affected.
