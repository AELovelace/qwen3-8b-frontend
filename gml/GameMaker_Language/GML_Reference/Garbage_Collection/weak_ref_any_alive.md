...
| --- | --- | --- |
| array | [Array](../../GML_Overview/Arrays.md) of [Struct Weak Reference](weak_ref_create.md)s | Array containing weak references to the structs that you want to check |
| index | [Real](../../GML_Overview/Data_Types.md) | The index into the array to start checking from |
| length | [Real](../../GML_Overview/Data_Types.md) | The number of positions, starting from the given index, to check for |
