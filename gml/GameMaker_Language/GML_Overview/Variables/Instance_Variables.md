...
An **instance** variable is created within an instance of an object and is considered unique to that instance \- i.e.: many instances of the same object can have the same variable, but each variable can hold a different value as they are *unique* to each instance. But *how* is an instance variable created? Well, you create new variables by simply assigning a value to them as shown in this small example (this is called *declaring* the variable):
