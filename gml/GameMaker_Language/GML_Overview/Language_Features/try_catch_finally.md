...
Note that within the finally block you *cannot* use [break](break.md), [continue](continue.md), [exit](exit.md) or [return](return.md) statements as they have no meaning in this context and the compiler will generate an error if they are used.
