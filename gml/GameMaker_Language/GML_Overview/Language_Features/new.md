...
It is important to note that calling new on any function that has *not* been flagged as a constructor will cause a [runtime exception](../../../Additional_Information/Errors/Runner_Errors.md).
