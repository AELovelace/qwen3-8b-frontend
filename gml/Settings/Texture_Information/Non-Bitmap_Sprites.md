...
GameMaker has support for non\-[bitmap](#) sprites in the form of [vector](#)   and **Spine Skeletal Animation** files. Both these formats have their pros and cons, and the two sections below explain how to import them into [The Sprite Editor](../../The_Asset_Editors/Sprites.md) as well as a bit of information about how they are drawn.
...
To help you visualise how this is done, the image below is of the same vector Fireman sprite only now we can see the polygons that are used to render the image within GameMaker:
