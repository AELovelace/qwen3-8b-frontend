...
- Set the [Texture Group Format](../Texture_Groups.md#texture_group_format) to **Custom**.
- Enter the tool to use, along with the settings under [Custom Options](../Texture_Groups.md#custom_options). For example, to generate medium quality BC7 compressed textures, set this to BCN \-u2.
