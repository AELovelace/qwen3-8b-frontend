...
- **Emscripten SDK location**: This is the location of the Emscripten SDK, required for YYC builds made for GX.games. Read [Setting Up For GX.games](https://github.com/YoYoGames/GameMaker-Bugs/wiki/GX.Games-GMS2) for information on setting up the SDK.
