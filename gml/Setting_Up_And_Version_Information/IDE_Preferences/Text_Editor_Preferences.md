...
The Legacy Code Editor**preferences** are used to define how the different code/script editors look and feel. The main page has the following options:
...
- **Colour**: The default colour for the text being written to the window (default [ARGB](GML_Visual_Preferences.md#) \#FF53E270\).
...
- **Anti\-Aliasing**: Here you can set the [anti\-aliasing](GML_Visual_Preferences.md#) mode for the output windows font rendering. You can choose to let the IDE decide by selecting *Use Default*, or you can force it *On* or *Off* by selecting either of those options.
