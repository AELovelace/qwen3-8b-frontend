...
You can also open this window manually using [The Help Menu](../IDE_Navigation/Menus/The_Help_Menu.md).
  ...
  The updater is not available on the Ubuntu (Beta) GameMaker IDE.
...
Once an update is downloaded, you can click "**Restart Now**" to restart the IDE immediately to install the update or choose to install it when you manually close the IDE later.
...
After an IDE update has been installed, you will get the [Runtime Modules Dialog](Installation_Guide.md#h) which allows you to select the runtime modules to install.
