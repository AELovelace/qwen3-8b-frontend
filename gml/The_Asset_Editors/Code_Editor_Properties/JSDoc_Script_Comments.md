...
| --- | --- | --- |
| @description / @desc | A general description of what the function does | @desc \ |
| @param / @parameter / @arg / @argument | Information on an argument, with an optional [type](Feather_Data_Types.md) in {} (or multiple acceptable types separated by , or \|) | @param {type,type} name \ |
| @return / @returns | [Type](Feather_Data_Types.md) of data the function returns | @return {type,type} \ |
| [Feather](../../Setting_Up_And_Version_Information/IDE_Preferences/Feather_Settings.md) only | | |
...
| @context / @self | Sets the context for the function, which Feather auto\-complete uses to provide contextual information. Can be an object or a constructor. | @self \ |
| Legacy Code Editor only | | |
| @function / @func | The full function name including arguments | @func my\_func(args) |

Descriptions in your JSDoc comments support [Markdown](https://www.markdownguide.org/basic-syntax/), which is used when your function info is displayed in a [Contextual Tooltip](Feather_Features.md#h2).
...
- By using [Feather](../../Setting_Up_And_Version_Information/IDE_Preferences/Feather_Settings.md)'s [Quick Fixes](Feather_Features.md#h1) menu (press CTRL/CMD \+ Q or click the  icon). The option is visible when your text cursor is placed on a function header (i.e. the line where the function's name is defined).
...
It automatically inserted the correct data types for each parameter, as enemy\_obj is an object, num is a real and the function returns an array.
...
The start\_x and start\_y arguments are marked as optional, which means the code editor will now expect 2 to 4 arguments, as can be seen in the warning message:
  ...
  You will get the same behaviour if you use optional arguments in the function declaration. See [script functions](../../GameMaker_Language/GML_Overview/Script_Functions.md) for more information.
