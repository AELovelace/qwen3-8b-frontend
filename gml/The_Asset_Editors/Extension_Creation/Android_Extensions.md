...
- By converting special characters into their XML\-escaped version, where needed (e.g. \ becomes \&gt;, etc.)
...
You can inject code conditionally, depending on the value of one of the [Extension Options](../Extensions.md#extension_options).
...
\  
 ...
 \This content is injected IF condition \=\= match\  
...
Also see: [Using Extension Options](Creating_An_Extension.md#h2)
...
The ${YYAndroidMyInjectionTag} part here will be replaced with the contents of the \ \ group from the extension's Code Injection window.
...
For example, let's say you want to place the file google\-services.json into your Android project using the extension Extension1, then the final path for that file in your GameMaker project will be \/extensions/Extension1/AndroidSource/ProjectFiles.
