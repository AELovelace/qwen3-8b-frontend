...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Convert all HTML files in indexed-docs/gml/Manual to Markdown files."
    )
    parser.add_argument(
        "--input-dir",
        type=Path,
        default=Path("indexed-docs/gml/Manual"),
        help="Directory containing source HTML files.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("indexed-docs/gml/Manual_md"),
