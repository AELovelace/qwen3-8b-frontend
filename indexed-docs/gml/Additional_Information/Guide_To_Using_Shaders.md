...
- Next, we need to add this fourth component to multiply it with the MATRIX\_WORLD\_VIEW\_PROJECTION matrix, which is a 4x4 matrix. This multiplication will project the local position of the vertex into screen coordinates.
