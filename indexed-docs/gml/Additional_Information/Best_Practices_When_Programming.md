...
There are many, many [programming styles](https://en.wikipedia.org/wiki/Programming_style), and some would argue that theirs is the best one to use, but the truth is that almost any style is fine as long as you are **consistent** when using it and it is *clear* and *obvious* what everything is and does.
