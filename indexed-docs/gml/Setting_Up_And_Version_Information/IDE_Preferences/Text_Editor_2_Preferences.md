...
This page describes all the preferences for [Code Editor 2 (Beta)](../../The_Asset_Editors/The_Text_Editor.md), which contains the following sections:
...
- **Navigation Orientation**: This controls where the Navigation Bar is shown in the [Editor Frame](../../The_Asset_Editors/The_Text_Editor.md#h). The Navigation Bar is where you choose which asset and document is open for editing. (Default: Top)
...
- **Show line numbers**: Whether line numbers are displayed in the [Gutter](../../The_Asset_Editors/The_Text_Editor.md#h1). (Default: Enabled)

### Scrollbars

- **Scrollbar Mode**: The [Vertical Scrollbar](../../The_Asset_Editors/The_Text_Editor.md#h2) mode to use. You can choose from the following:
...
- **Show Indent Guide**: Display vertical indentation lines. See: [Guides](../../The_Asset_Editors/Code_Editor_Properties/Editing_Text.md#h3). (Default: Enabled)
- **Show whitespace**: Display whitespace guides (dots). See: [Guides](../../The_Asset_Editors/Code_Editor_Properties/Editing_Text.md#h3). (Default: Disabled)
- **Show Rainbow Brackets**: Enable [Rainbow Brackets](../../The_Asset_Editors/Code_Editor_Properties/Editing_Text.md#h). Colours can be modified in the Theme section. (Default: Enabled)
...
- **Autofill JSDoc header comments**: Controls whether JSDoc is auto\-generated for functions. See: [Auto\-Generating JSDoc](../../The_Asset_Editors/Code_Editor_Properties/JSDoc_Script_Comments.md#h) (Default: Disabled)
...
- **Auto Indent Mode**: See [Auto\-Indent](../../The_Asset_Editors/Code_Editor_Properties/Editing_Text.md#h1).
- **Auto Indent clipboard contents**: Whether automatic indentation should be applied to pasted code.   This feature is currently disabled and will not have any effect.
...
- **Invoke Code Completion List in contextually appropriate locations after Spacebar**: This controls whether the code completion list is brought up after you press the SPACE key with the text cursor at a location in your code where this may be appropriate, e.g. when you press Space after typing if (my\_var \=\=. (Default: Enabled)
- **Invoke Code Completion List when typing function call arguments**: This controls whether the code completion list is brought up when typing function call arguments. (Default: Enabled)
- **Always show Parameter Tooltip when Text Cursor is inside a function call's arguments**: This controls whether the parameter tooltip is always shown when the text cursor is at a position in your code where a function call's arguments go. See: [Contextual Tooltip](../../The_Asset_Editors/Code_Editor_Properties/Feather_Features.md#h2). (Default: Disabled)
...
This contains colours for the [Gutter](../../The_Asset_Editors/The_Text_Editor.md#h1) elements, like its background and foreground colours, colour of the divider between the document view and the gutter, colour of the togglable rail and the colour of the document header text.

### Scopes

This allows you to edit the colour for each scope that can be detected in a document. You can change the foreground and background colours, and whether to use bold, italic and/or underline formatting.
...
The "**Name**" field is the display name of the scope shown in this list, and the "**Scopes**" field is a list of scopes to cover under this name, separated by commas.
