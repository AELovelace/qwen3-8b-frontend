...
- **Open new moments for edit on creation**: Normally when you add a new moment to a timeline, GameMaker will automatically open the editor for you to add your code or GML Visual to it. However if you un\-check this option, the moment will be added without opening the editor (you can open it by double clicking  on the moment). By default this option is on.
