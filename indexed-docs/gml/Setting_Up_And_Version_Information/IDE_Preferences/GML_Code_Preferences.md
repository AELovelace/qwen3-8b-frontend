...
The **GML Code Preferences** are used to define how some of the language features for coding will be displayed in the IDE of GameMaker. The options for GML Code are as follows:

- **Display argument types in status bar**: This option relates to when you are using your own custom scripts and have used JSDoc notation to identify the different arguments, etc. (see [JSDoc Comments](../../The_Asset_Editors/Code_Editor_Properties/JSDoc_Script_Comments.md) for more information). When this option is checked, and you have specified the argument types in the script, then they will be shown in the status bar at the bottom of the editor, enclosed in { }. This is off by default.
