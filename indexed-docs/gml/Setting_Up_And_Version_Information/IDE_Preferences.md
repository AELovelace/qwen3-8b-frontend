...
The **Preferences Window** is an essential part of GameMaker, as it is where you can set up and customise your experience using the IDE as well as set up any specific platform SDK's, etc.
...
The "**Import Preferences**" button allows you to import preferences from a previous GameMaker installation. It opens the data folder for a previous installation, if it can find one, where you are able to select the local\_settings.json file to import. After confirming the import, you can choose to revert back to the previous preferences if you see any issues. 
...
\~/Library/Application Support/GameMakerStudio2/\/
  ...
  In previous versions of GameMaker the .config folder was used instead of the Library/Application Support folder. GameMaker will automatically move the contents of the old folder to the new one upon login if the new folder doesn't exist yet.
...
Once the Preferences window is open you will have the following different options (this list omits all platform\-specific preferences, for those, please see [Platform Preferences](Platform_Preferences.md)):
...
- [Legacy Code Editor Preferences](IDE_Preferences/Text_Editor_Preferences.md)
- [Code Editor 2 Preferences](IDE_Preferences/Text_Editor_2_Preferences.md)
...
- [Prefab Library Preferences](IDE_Preferences/General/Prefab_Library_Preferences.md)
...
Beta versions of GameMaker starting with 2024\.800\+ will also contain [GMRT Preferences](IDE_Preferences/GMRT_Preferences.md).
