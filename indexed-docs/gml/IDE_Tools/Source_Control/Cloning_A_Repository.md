...
- In the URL field, type the path to the project that we setup in the [Reverting Files guide](Reverting_Files.md) (by default this will be \:\\Users\\\\\GameMakerProjects\\\).
