...
The above action block code sets a font, the font colour and then aligns the text to draw from the center before actually drawing the "level\_num" value along with the caption "Level: ".
