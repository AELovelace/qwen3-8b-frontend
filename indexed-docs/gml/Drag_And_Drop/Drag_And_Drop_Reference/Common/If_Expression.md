...
The above action block code checks to see if the instance variable "player\_score" is greater than 1000 *and* that the instance variable "player\_level" is less than 10\. if both checks return true then the action code goes on to assign new values to these variables.
