...
For further technical help with things like setting up the different target platforms you should see the [GameMaker Wiki](https://github.com/YoYoGames/GameMaker-Bugs/wiki), and GameMaker also run a series of [Tech Blogs](https://gamemaker.io/en/blog/category/tech) which cover all sorts of different aspects of using GameMaker, from the most basic concepts to the most advanced techniques so there's something there for everybody. In particular, have a look at the following article:
