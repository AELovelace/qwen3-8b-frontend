...
Global variables are stored in a [struct](../Structs.md#struct), which you can access like any other struct. To refer to this struct you use the global keyword.
...
- [event\_data](../../GML_Reference/Game_Input/Gesture_Input/event_data.md)
