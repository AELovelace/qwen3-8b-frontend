...
Note that you can define a default comment to be created for all events from the [Object Editor Preferences](../../Setting_Up_And_Version_Information/IDE_Preferences/Object_Editor_Preferences.md).
