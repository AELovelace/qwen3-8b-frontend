...
| w\_anchor1\_x | [Real](../../../GML_Overview/Data_Types.md) | The x coordinate where the first part of joint is anchored, within the game world |
| w\_anchor1\_y | [Real](../../../GML_Overview/Data_Types.md) | The y coordinate where the first part of the joint is anchored, within the game world |
| w\_anchor2\_x | [Real](../../../GML_Overview/Data_Types.md) | The x coordinate where the second part of the joint is anchored, within the game world |
| w\_anchor2\_y | [Real](../../../GML_Overview/Data_Types.md) | The y coordinate where the second part of the joint is anchored, within the game world |
| l\_anchor1\_x | [Real](../../../GML_Overview/Data_Types.md) | The local x coordinate where joint 1 is anchored to the first instance |
| l\_anchor1\_y | [Real](../../../GML_Overview/Data_Types.md) | The local y coordinate where joint 1 is anchored to the first instance |
| l\_anchor2\_x | [Real](../../../GML_Overview/Data_Types.md) | The local x coordinate where joint 2 is anchored to the second instance |
| l\_anchor2\_y | [Real](../../../GML_Overview/Data_Types.md) | The local y coordinate where joint 2 is anchored to the second instance |
| ratio | [Real](../../../GML_Overview/Data_Types.md) | Set the velocity ratio between two instances |
