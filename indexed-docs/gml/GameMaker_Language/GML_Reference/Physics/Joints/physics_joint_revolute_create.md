...
This function creates a revolute joint between two physics instances.
...
| w\_anchor\_x | [Real](../../../GML_Overview/Data_Types.md) | The x coordinate for the joint, within the game world |
| w\_anchor\_y | [Real](../../../GML_Overview/Data_Types.md) | The y coordinate for the joint, within the game world |
| ang\_min\_limit | [Real](../../../GML_Overview/Data_Types.md) | The lower permitted limit for the joint angle, in degrees |
| ang\_max\_limit | [Real](../../../GML_Overview/Data_Types.md) | The upper permitted limit for the joint angle, in degrees |
| ang\_limit | [Boolean](../../../GML_Overview/Data_Types.md) | Whether the to limit the angle of the joint (true) or not (false) |
| max\_motor\_torque | [Real](../../../GML_Overview/Data_Types.md) | Sets the maximum motor torque used to achieve the desired motor speed (in newton per meter) |
