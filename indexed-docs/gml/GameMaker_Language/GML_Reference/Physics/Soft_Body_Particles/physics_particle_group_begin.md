...
| [Physics Particle Group Flag Constant](../../../../../GameMaker_Language/GML_Reference/Physics/Soft_Body_Particles/physics_particle_group_begin.md) | |
| --- | --- |
...
It is important to note that calling this function does *not* create the group in the physics room. This function simply begins the process and sets the base particle properties for the group. To actually create the particle group you need to give it a *form* (see the example below) and then call the function [physics\_particle\_group\_end()](physics_particle_group_end.md), at which point it will be created.
...
| --- | --- | --- |
| flags | [Physics Particle Flag Constant](../../../../../GameMaker_Language/GML_Reference/Physics/Soft_Body_Particles/physics_particle_create.md)(s) | The flags to set on the particle. |
| groupflags | [Physics Particle Group Flag Constant](../../../../../GameMaker_Language/GML_Reference/Physics/Soft_Body_Particles/physics_particle_group_begin.md)(s) | The group flags to set on the particle group (see table at the top). |
| x | [Real](../../../../../LINKGOESHERE) | The x position to create the particle group at. |
| y | [Real](../../../../../LINKGOESHERE) | The y position to create the particle group at. |
| ang | [Real](../../../../../LINKGOESHERE) | The angle (in degrees) to rotate the group to on create. |
| xv | [Real](../../../../../LINKGOESHERE) | The initial horizontal velocity. |
| yv | [Real](../../../../../LINKGOESHERE) | The initial vertical velocity. |
| ang\_velocity | [Real](../../../../../LINKGOESHERE) | The initial angular velocity. |
| col | [Colour](../../../../../GameMaker_Language/GML_Reference/Drawing/Colour_And_Alpha/Colour_And_Alpha.md) | The base colour to use for the particle group. |
| alpha | [Real](../../../../../LINKGOESHERE) | The base alpha to use for the particle group. |
| strength | [Real](../../../../../LINKGOESHERE) | Set the cohesion strength between particles in the group. |
| category | [Real](../../../../../LINKGOESHERE) | The user defined category to which the group belongs. |
