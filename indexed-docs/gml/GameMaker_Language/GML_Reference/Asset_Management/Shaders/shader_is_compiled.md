...
This function will check a shader at runtime to make sure that it has been successfully compiled. If it has then the function returns true, otherwise it returns false.
...
If your shader has *not* been compiled and you call [shader\_set](shader_set.md), the game will crash, so it is worthwhile having some sort of check whenever you are using anything other than simple GLSL ES shaders.
...
| --- | --- | --- |
| shader | [Shader Asset](../../../../The_Asset_Editors/Shaders.md) | The shader to check |
