...
| --- | --- | --- |
| x | [Real](../../../GML_Overview/Data_Types.md) | The x position to check for instances far from. |
| y | [Real](../../../GML_Overview/Data_Types.md) | The y position to check for instances far from. |
