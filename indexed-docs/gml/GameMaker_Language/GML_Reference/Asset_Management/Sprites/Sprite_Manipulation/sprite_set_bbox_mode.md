...
| --- | --- | --- |
| ind | [Sprite Asset](../../../../../The_Asset_Editors/Sprites.md) | The index of the sprite to change the mode of. |
| mode | [Bounding Box Mode Constant](sprite_set_bbox_mode.md) | The mode to set (a constant). |
