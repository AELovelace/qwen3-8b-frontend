...
The returned array contains the (x, y) coordinates of the points in pairs, e.g., element 0 holds the x coordinate of the first point and element 1 its y coordinate, element 2 holds the x coordinate of the second point and element 3 its y coordinate, etc.
  ...
  The function returns the points in *counterclockwise* order. If you use these points to create a polygon fixture for use with the physics engine you need to pass them in reverse order to specify them in *clockwise* order. See [physics\_fixture\_add\_point](../../../Physics/Fixtures/physics_fixture_add_point.md).
...
| --- | --- | --- |
| sprite | [Sprite Asset](../../../../../The_Asset_Editors/Sprites.md) | The sprite to generate the convex hull of |
| max\_pts | [Real](../../../../GML_Overview/Data_Types.md) | The maximum number of points to return in the array or no maximum if not specified (as many points as it takes to generate the shape) |
| subimg | [Real](../../../../GML_Overview/Data_Types.md) | The subimage of the sprite (defaults to 0\) |
