...
You can also add skins through code using [skeleton\_skin\_create](skeleton_skin_create.md).
  ...
  For skins added using [skeleton\_skin\_create](skeleton_skin_create.md) you must pass the struct returned by the function instead of the name.
...
| --- | --- | --- |
| skin | [String](../../../../../../../GameMaker_Language/GML_Overview/Data_Types.md) or [Skeleton Skin Struct](../../../../../../../GameMaker_Language/GML_Reference/Asset_Management/Sprites/Skeletal_Animation/Skins/skeleton_skin_create.md) | The name of the skin to use as a string (for skins defined in the animation program) or a struct (for skins added using [skeleton\_skin\_create](skeleton_skin_create.md)) |
