...
This function is used to enable or disable [SDF Rendering](Fonts.md#h) for the given font. The font must have been added using [font\_add()](font_add.md) and loaded from a font file \- you cannot use SDF with sprite fonts or fonts that were added through the IDE.

Once SDF is enabled for a font, you can apply various [effects](font_enable_effects.md) to it.

  This function cannot be used on HTML5, as HTML5 does not support adding freetype fonts. However, SDF can still be used on HTML5 by enabling it for a font [through the IDE](../../../../The_Asset_Editors/Fonts.md).
...
| --- | --- | --- |
| ind | [Font Asset](../../../../The_Asset_Editors/Fonts.md) | The index of the font for which to enable/disable SDF rendering |
| enable | [Boolean](../../../GML_Overview/Data_Types.md) | Whether to enable SDF rendering for the font or not |
