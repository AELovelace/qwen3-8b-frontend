...
| --- | --- | --- |
| sequence\_struct\_or\_id | Sequence Asset or Sequence Object Struct | The sequence to check for, can be the asset reference itself or its Sequence object struct. |
