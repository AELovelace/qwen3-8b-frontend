...
The type argument can be any of the *asset* or *parameter* track constants under the [Sequence Track Type Constant](Sequence_Structs/The_Track_Struct.md#type). seqtracktype\_message and seqtracktype\_moment cannot be used, as they refer to special tracks.
...
| --- | --- | --- |
| type | [Sequence Track Type Constant](Sequence_Structs/The_Track_Struct.md#type) | The type of track to create (except seqtracktype\_message and seqtracktype\_moment) |
