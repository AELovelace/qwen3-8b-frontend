...
The above code creates a new animation curve struct and stores it in a variable my\_curve. This struct is then populated with a name and a channel array. The channel array contains a single channel with three points.
