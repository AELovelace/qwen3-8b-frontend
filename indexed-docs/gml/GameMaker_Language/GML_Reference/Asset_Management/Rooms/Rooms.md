...
Rooms are where everything happens in your game. You create them in the [IDE](../../../../The_IDE/The_IDE.md "GameMaker IDE") using [The Room Editor](../../../../The_Asset_Editors/Rooms.md) or at runtime using the functions under [Modifying Rooms](Rooms.md#modifying_rooms "functions for Modifying Rooms").
...
The following [global variables](../../../GML_Overview/Variables/Global_Variables.md) and functions can be used for getting basic information about any given room:

- [room\_first](room_first.md)
- [room\_last](room_last.md)
- [room\_next](room_next.md)
- [room\_previous](room_previous.md)
- [room](room.md)
- [room\_speed](room_speed.md)
- [room\_height](room_height.md)
- [room\_width](room_width.md)
...
- [room\_get\_info](room_get_info.md)

### Switching Rooms

- [room\_goto](room_goto.md)
- [room\_goto\_next](room_goto_next.md)
- [room\_goto\_previous](room_goto_previous.md)
- [room\_restart](room_restart.md)

### Modifying Rooms

  These functions should *never be run from within the room that you wish to change*, but rather be run from an instance in another room first.

  If you change any room asset in this way, the change is **permanent** and will be maintained for the entire duration of the game, even if you call the [room\_restart](room_restart.md) function (closing and restarting the game will reset the room properties though).

- [room\_add](room_add.md)
...
- [room\_set\_height](room_set_height.md)
...
- [room\_get\_viewport](room_get_viewport.md)
...
- [Sprite Elements](Sprite_Layers/Sprite_Layers.md)
- [Sequence Elements](Sequence_Layers/Sequence_Layers.md)
- [Text Elements](Text_Functions/Text_Elements.md)
- [Particle System Elements](Particle_System_Layers/Particle_System_Elements.md)
- [UI Layers](UI_Layers/layer_get_flexpanel_node-copy.md)

### Filters and Effects

- [Filter and Effect Functions](Filter_Effect_Layers/Filter_Effect_Functions.md)

  When creating room layers *you can have multiple different element types on one layer*. So, for example, you may have a layer for enemies, and on that layer have the enemy instances as well as certain sprite assets that are only related to that enemy. Or you could have a background element with a tile map element to create the look of a room. This is not permitted in [The Room Editor](../../../../The_Asset_Editors/Rooms.md), but when creating things dynamically you can do this, which is why functions like [layer\_get\_all\_elements](General_Layer_Functions/layer_get_all_elements.md) exist.
