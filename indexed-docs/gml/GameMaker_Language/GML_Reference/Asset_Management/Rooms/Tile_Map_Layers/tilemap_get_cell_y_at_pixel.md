...
| --- | --- | --- |
| tilemap\_element\_id | [Tile Map Element ID](layer_tilemap_get_id.md) | The unique ID value of the tile map element to get the cell y position of |
| x | [Real](../../../../GML_Overview/Data_Types.md) | The x position within the room to use for getting the cell |
| y | [Real](../../../../GML_Overview/Data_Types.md) | The y position within the room to use for getting the cell |
