...
| --- | --- | --- |
| tilemap\_element\_id | [Tile Map Element ID](layer_tilemap_get_id.md) | The unique ID value of the tile map element to set the height of |
| height | [Real](../../../../GML_Overview/Data_Types.md) | The height value (in "cells") |
