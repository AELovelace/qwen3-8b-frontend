...
You supply the room to be copied to (either as defined in [The Asset Browser](../../../../Introduction/The_Asset_Browser.md) or as returned by the function [room\_add](room_add.md)) as well as the index of the source room.
...
| --- | --- | --- |
| ind | [Room Asset](../../../../The_Asset_Editors/Rooms.md) | The room to be *copied to*. |
| source | [Room Asset](../../../../The_Asset_Editors/Rooms.md) | The room to be *copied from*. |
