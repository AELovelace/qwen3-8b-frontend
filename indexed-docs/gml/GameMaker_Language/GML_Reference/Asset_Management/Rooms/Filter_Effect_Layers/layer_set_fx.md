...
This function is used to assign an FX struct to a Room Layer. You specify either the ID or the name of the layer you want to modify, and then an FX struct (as returned from [fx\_create()](fx_create.md) or [layer\_get\_fx()](layer_get_fx.md)) which will be applied to the specified layer, making the effect visible in the room.
...
| --- | --- | --- |
| layer\_name\_or\_id | [String](../../../../../../GameMaker_Language/GML_Overview/Data_Types.md) or [Layer ID](../../../../../../GameMaker_Language/GML_Reference/Asset_Management/Rooms/General_Layer_Functions/layer_get_id.md) | The name or ID of the layer to modify |
| filter\_or\_effect | [FX Struct](../../../../../../GameMaker_Language/GML_Reference/Asset_Management/Rooms/Filter_Effect_Layers/fx_create.md) | The FX struct to apply to the layer |
