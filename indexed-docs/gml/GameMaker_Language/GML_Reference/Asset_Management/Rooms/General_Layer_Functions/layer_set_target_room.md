...
When you are finished adding layers or layer elements to a room, call the function [layer\_reset\_target\_room](layer_reset_target_room.md) to reset the room target or call this function again with a room argument of \-1.
  ...
  This will change the behaviour of [layer\_get\_all](layer_get_all.md), see the linked page for more info.
...
| --- | --- | --- |
| room | [Room Asset](../../../../../The_Asset_Editors/Rooms.md) | The room to target for all further layer functions, or \-1 for the current room |
