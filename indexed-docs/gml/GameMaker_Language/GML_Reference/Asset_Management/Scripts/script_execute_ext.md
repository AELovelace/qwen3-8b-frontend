...
You can also pass two optional arguments to the function to specify an offset into the array to get the arguments from, as well as the number of arguments num\_args to use from the array (this must be a maximum of array\_length(array\_args) \- offset).
  ...
  Use [script\_execute](script_execute.md) to pass the call arguments as individual parameters instead of an array.
...
| array\_args | [Array](../../../GML_Overview/Arrays.md) | The array containing the arguments. Can be omitted if the function/script takes no arguments. |
| offset | [Real](../../../GML_Overview/Data_Types.md) | The offset into the argument array. See [Offset And Length](../../Variable_Functions/Array_Functions.md#offset_and_length) |
| num\_args | [Real](../../../GML_Overview/Data_Types.md) | The number of arguments to use (from the offset onwards). See [Offset And Length](../../Variable_Functions/Array_Functions.md#offset_and_length) |

 

#### Returns:

[Any](../../../GML_Overview/Data_Types.md#variable) (Will depend on the return value from the function/script being called)
