...
| --- | --- | --- |
| index | [Sound Asset](../../../../The_Asset_Editors/Sounds.md) or [Sound Instance ID](audio_play_sound.md) | The index of the sound to change. |
| time | [Real](../../../GML_Overview/Data_Types.md) | The time (in seconds) to set the start point to. Values beyond the end of the sound are clamped to its length. |
