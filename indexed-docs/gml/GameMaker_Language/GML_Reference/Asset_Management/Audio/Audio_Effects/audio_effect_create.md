...
| --- | --- | --- |
| type | [AudioEffectType Enum](AudioEffectType.md) | The type of audio effect to create (e.g. AudioEffectType.Reverb1) |
| params | [Struct](../../../../../../GameMaker_Language/GML_Overview/Structs.md) | The parameters of the audio effect (see [AudioEffect Struct](AudioEffect.md) for the available parameters) |
...
The above code first creates a new distortion effect of type [AudioEffectType.Bitcrusher](AudioEffectType.md#h2) using [audio\_effect\_create](audio_effect_create.md). It then configures the effect by setting the effect's parameters.
