...
| falloff\_ref | Real | The falloff reference relative to the listener (clamp). |
| falloff\_max | Real | The maximum falloff distance relative to the listener. |
| falloff\_factor | Real | The falloff factor (default 1\). |
