...
The buffer should have been created previously (see the [buffer functions](../../../Buffers/Buffers.md) for details on how to do this), and have had data added or loaded into it. You then pass it to this function with the data format (only buffer\_u8 or buffer\_s16 are currently supported), the sample rate (which can be between 8000hz and 48000hz), and an offset into the buffer to get the data from.
  ...
  You cannot pass a buffer of the type [buffer\_grow](../../../Buffers/buffer_create.md) into this function.
...
| [Audio Channel Constant](audio_create_buffer_sound.md) | |
| --- | --- |
| Constant | Description |
| audio\_mono | Mono (single channel) audio |
| audio\_stereo | Stereo (dual channel) audio |
| audio\_3d | 3D (5\.1\) audio |
...
You can't delete the buffer if any sound has been created from it and the sound has not been freed up first. So you would free the sound(s) first, and *then* delete the buffer.
...
| --- | --- | --- |
| bufferId | [Buffer](../../../Buffers/buffer_create.md) | The ID of the buffer to use. |
| bufferFormat | [Buffer Data Type Constant](../../../Buffers/buffer_write.md) | The format of the data in the buffer (buffer\_u8 or buffer\_s16). |
| bufferRate | [Real](../../../../GML_Overview/Data_Types.md) | The sample rate of the data in the buffer. |
| bufferOffset | [Real](../../../../GML_Overview/Data_Types.md) | The offset into the buffer to read the sample data from (in bytes). |
| bufferLength | [Real](../../../../GML_Overview/Data_Types.md) | The length of the buffer (the number of bytes of audio data, excluding the header). |
| bufferChannels | [Audio Channel Constant](audio_create_buffer_sound.md) | The channels to use from one of the constants listed above. |
