...
| --- | --- | --- |
| str | [String](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The string to copy from. |
| index | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The position of the first character in the string to copy from (numbered from 1\) |
| count | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The number of characters, starting from the position of the first, to copy |
