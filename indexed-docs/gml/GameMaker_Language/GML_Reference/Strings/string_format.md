...
| --- | --- | --- |
| val | [Real](../../GML_Overview/Data_Types.md) | The real number to be converted to a string. |
| total | [Real](../../GML_Overview/Data_Types.md) | The number of places of the main number to be shown (left side of decimal). Spaces will be inserted to match this. |
| dec | [Real](../../GML_Overview/Data_Types.md) | The number of decimal places to be included (right side of decimal). Zeroes will be inserted to match this. |
