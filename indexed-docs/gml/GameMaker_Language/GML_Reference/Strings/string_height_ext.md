...
| --- | --- | --- |
| string | [String](../../GML_Overview/Data_Types.md) | The string to measure the height of. |
| sep | [Real](../../GML_Overview/Data_Types.md) | The distance in pixels between lines of text as if the string was being drawn. |
| w | [Real](../../GML_Overview/Data_Types.md) | The maximum width (in pixels) of the string before a line break as if the string was being drawn. |
