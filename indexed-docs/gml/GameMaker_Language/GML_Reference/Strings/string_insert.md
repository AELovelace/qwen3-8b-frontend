...
| --- | --- | --- |
| substr | [String](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The substring to be inserted. |
| str | [String](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The string to be copied. |
| index | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The position in characters of the string to insert the substring. |
