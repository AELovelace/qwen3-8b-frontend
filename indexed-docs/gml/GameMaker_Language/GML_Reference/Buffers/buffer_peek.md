...
| offset | [Real](../../GML_Overview/Data_Types.md) | The offset position (in bytes) within the buffer to read the given data from. |
| type | [Buffer Data Type Constant](buffer_write.md) | The type of data that is to be read from the buffer (see the list of constants [here](buffer_read.md)). |
