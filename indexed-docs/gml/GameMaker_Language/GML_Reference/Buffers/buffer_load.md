...
This function loads a buffer that was previously saved using the [buffer\_save](buffer_save.md) functions, as well as any [Included Files](../../../Settings/Included_Files.md) or other files stored externally.
...
| --- | --- | --- |
| filename | [String](../../GML_Overview/Data_Types.md) | The name of the file to load from. |
