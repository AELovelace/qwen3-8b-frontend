...
| --- | --- | --- |
| buffer | [Buffer](../../../../GameMaker_Language/GML_Reference/Buffers/buffer_create.md) | The buffer to compress. |
| offset | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The offset within the buffer to compress (in bytes). |
| size | [Real](../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The size of the buffer area to compress (in bytes). |

 

#### Returns:

[Buffer](../../../../GameMaker_Language/GML_Reference/Buffers/buffer_create.md) or \-1 in case anything went wrong
