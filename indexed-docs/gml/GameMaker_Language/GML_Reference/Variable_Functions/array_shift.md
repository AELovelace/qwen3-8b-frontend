...
The function works identically to [array\_pop](array_pop.md), but removes and returns the *first* element instead of the *last* one.

  Use [array\_first](array_first.md) to get the first element without removing it from the array.
...
| --- | --- | --- |
| array | [Array](../../../../GameMaker_Language/GML_Overview/Arrays.md) | The array to *shift*, i.e. to return and remove the first element from |

 

#### Returns:

[Any](../../../../GameMaker_Language/GML_Overview/Data_Types.md#variable) (the type of the removed first array element)
...
Using the functions [array\_pop](array_pop.md) and [array\_insert](array_insert.md) arrays can be rotated *right* instead.
