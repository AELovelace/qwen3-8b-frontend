...
| "ref" | The variable holds a [handle](../../GML_Overview/Data_Types.md) reference |
...
| --- | --- | --- |
| variable | [Any](../../GML_Overview/Data_Types.md#variable) | The variable to get the data type of. |
