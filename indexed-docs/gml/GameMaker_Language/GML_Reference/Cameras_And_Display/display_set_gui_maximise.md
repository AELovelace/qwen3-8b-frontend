...
display\_set\_gui\_maximise(*xscale, yscale, xoffset, yoffset*)

| Argument | Type | Description |
| --- | --- | --- |
| xscale | [Real](../../GML_Overview/Data_Types.md) | OPTIONAL The horizontal scaling factor (use \-1 to reset to default). |
| yscale | [Real](../../GML_Overview/Data_Types.md) | OPTIONAL The vertical scaling factor (use \-1 to reset to default). |
| xoffset | [Real](../../GML_Overview/Data_Types.md) | OPTIONAL The x offset position for drawing. |
| yoffset | [Real](../../GML_Overview/Data_Types.md) | OPTIONAL The y offset position for drawing. |
