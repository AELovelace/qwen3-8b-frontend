...
| --- | --- | --- |
| aa | [Real](../../GML_Overview/Data_Types.md) | The level of anti\-aliasing filtering (0, 2, 4 or 8\) |
| vsync | [Boolean](../../GML_Overview/Data_Types.md) | Toggle vertical synchronisation to on (true) or off (false) |
