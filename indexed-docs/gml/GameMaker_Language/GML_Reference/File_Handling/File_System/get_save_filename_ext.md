...
| directory | [String](../../../GML_Overview/Data_Types.md) | The directory to start the search from |
| caption | [String](../../../GML_Overview/Data_Types.md) | The caption for the window |
...
var \_file \= get\_save\_filename\_ext("screenshot\|\*.png", "", working\_directory, "Save a level here");  
...
The above code will ask the user to select an image file name file for saving in the working directory and then check the returned file name and path If it is not an empty string it takes a screenshot and saves it using the given name.
