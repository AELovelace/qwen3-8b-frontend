...
This function takes an existing [DS Map](../../Data_Structures/DS_Maps/ds_map_create.md) and encodes its contents as a JSON string.

The JSON string can be used, e.g., as part of an [http\_post\_string](../../Asynchronous_Functions/HTTP/http_post_string.md) call or be written to a file, so the data can be stored externally.

  This function \- while still valid for DS maps \- has been superseded by the function [json\_stringify](json_stringify.md) and [structs](../../../GML_Overview/Structs.md), and we recommend that you only use this function for legacy support.

The DS map can contain the following: 

- Nested [DS Maps](../../Data_Structures/DS_Maps/DS_Maps.md) and [DS Lists](../../Data_Structures/DS_Lists/DS_Lists.md) that should be marked correctly using the DS map [JSON](../../Data_Structures/DS_Maps/DS_Maps.md#func_ref_json) functions (e.g. [ds\_map\_add\_map](../../Data_Structures/DS_Maps/ds_map_add_map.md), [ds\_map\_add\_list](../../Data_Structures/DS_Maps/ds_map_add_list.md)) and the DS list [JSON](../../Data_Structures/DS_Lists/DS_Lists.md#func_ref_json) functions (e.g. [ds\_list\_mark\_as\_map](../../Data_Structures/DS_Lists/ds_list_mark_as_map.md), [ds\_list\_mark\_as\_list](../../Data_Structures/DS_Lists/ds_list_mark_as_list.md)) respectively.
...
- The DS map keys are not added to the JSON string in a particular order.
- GameMaker encodes certain values in the JSON as a string so they can be read back correctly later. See [Data Conversions](../../../../Additional_Information/Guide_To_Using_JSON.md#data_conversions) for an overview of these conversions.
...
| --- | --- | --- |
| map | [DS Map](../../Data_Structures/DS_Maps/ds_map_create.md) | A DS map with the information to encode |
| prettify | [Boolean](../../../GML_Overview/Data_Types.md) | Whether to prettify the output, i.e. insert indentation and line breaks for readability. Defaults to false. |
