...
An optional mapping function can be provided to determine which values in the DS grid should be considered "empty" or "occupied".
  ...
  To convert from MP grid to DS grid, see [mp\_grid\_to\_ds\_grid](../../Movement_And_Collisions/Motion_Planning/mp_grid_to_ds_grid.md).
...
| --- | --- | --- |
| **value** | [Real](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The value in the current cell |
| **x** | [Real](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The x index/position of the grid cell |
| y | [Real](../../../../../GameMaker_Language/GML_Overview/Data_Types.md) | The y index/position of the grid cell |
...
| Argument | Type | Description |
| --- | --- | --- |
| ds\_grid | [DS Grid ID](../../../../../GameMaker_Language/GML_Reference/Data_Structures/DS_Grids/ds_grid_create.md) | The DS grid to convert |
| mp\_grid | [MP Grid ID](../../../../../GameMaker_Language/GML_Reference/Movement_And_Collisions/Motion_Planning/mp_grid_create.md) | The MP grid to write the data to |
| func | [Function](../../../../../GameMaker_Language/GML_Overview/Script_Functions.md) | The mapping function to use |

 

#### Returns:

[MP Grid ID](../../../../../GameMaker_Language/GML_Reference/Movement_And_Collisions/Motion_Planning/mp_grid_create.md)
