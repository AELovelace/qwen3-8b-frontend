...
| x1 | [Real](../../../GML_Overview/Data_Types.md) | The x position of the left of the region in the grid, from 0 to (grid width \- 1\). |
| y1 | [Real](../../../GML_Overview/Data_Types.md) | The y position of the top of the region in the grid, from 0 to (grid height \- 1\). |
| x2 | [Real](../../../GML_Overview/Data_Types.md) | The x position of the right of the region in the grid, from 0 to (grid width \- 1\). |
| y2 | [Real](../../../GML_Overview/Data_Types.md) | The y position of the bottom of the region in the grid, from 0 to (grid height \- 1\). |
