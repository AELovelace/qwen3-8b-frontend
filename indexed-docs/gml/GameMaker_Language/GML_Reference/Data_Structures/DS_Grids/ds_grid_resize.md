...
| --- | --- | --- |
| index | [DS Grid](ds_grid_create.md) | The grid to resize. |
| w | [Real](../../../GML_Overview/Data_Types.md) | The new width of the grid. |
| h | [Real](../../../GML_Overview/Data_Types.md) | The new height of the grid. |
