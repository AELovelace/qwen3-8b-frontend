...
With this function you can retrieve all of the values that a DS map contains for each key in the map.
...
| \[array] | [Array](../../../GML_Overview/Arrays.md) | OPTIONAL The array to append the DS map values to. |
