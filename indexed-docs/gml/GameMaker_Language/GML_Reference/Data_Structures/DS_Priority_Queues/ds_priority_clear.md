...
With this function you can clear all data from the given priority queue data structure. This does *NOT* destroy the data structure (for that you should use [ds\_priority\_destroy()](ds_priority_destroy.md)) it only wipes all data from it and returns an empty priority queue.
...
| --- | --- | --- |
| id | [DS Priority](ds_priority_create.md) | The handle of the data structure to clear. |
