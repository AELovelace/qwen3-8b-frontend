...
| [Time Source Unit Constant](../../../../GameMaker_Language/GML_Reference/Time_Sources/Time_Source_Units.md) | | |
| --- | --- | --- |
| Constant | Description | Value |
| time\_source\_units\_seconds | Use seconds for the Time Source period (frame\-independent) | 0 |
| time\_source\_units\_frames | Use frames for the Time Source period (frame\-dependent) | 1 |
