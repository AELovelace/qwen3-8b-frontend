...
This function creates a button control within the current debug section that uses (part of) a sprite. Clicking the button executes a [Function](../../GML_Overview/Script_Functions.md).
  ...
  This control isn't split into two columns but is shown in a single column.
...
| --- | --- | --- |
| ref | [Reference](../Variable_Functions/ref_create.md) or [Script Function](../../GML_Overview/Script_Functions.md) or [Function](../../GML_Overview/Script_Functions.md) | The function or a reference to the function to call when the button is clicked. |
| ref\_sprite | [Reference](../Variable_Functions/ref_create.md) | A reference to a variable that holds the [Sprite Asset](../../../The_Asset_Editors/Sprites.md) to use for the button. |
| ref\_sprite\_index | [Reference](../Variable_Functions/ref_create.md) | A reference to a variable that holds the index of the sprite subimage to use. |
| width | [Real](../../GML_Overview/Data_Types.md) | The width of the button in pixels. Defaults to the sprite's width. |
| height | [Real](../../GML_Overview/Data_Types.md) | The height of the button in pixels. Defaults to the sprite's height. |
| xoffset | [Real](../../GML_Overview/Data_Types.md) | The x offset into the sprite. The default is 0\. |
| yoffset | [Real](../../GML_Overview/Data_Types.md) | The y offset into the sprite. The default is 0\. |
| width\_sprite | [Real](../../GML_Overview/Data_Types.md) | The width of the sprite in pixels. Defaults to the sprite's width. |
| height\_sprite | [Real](../../GML_Overview/Data_Types.md) | The height of the sprite in pixels. Defaults to the sprite's height. |
