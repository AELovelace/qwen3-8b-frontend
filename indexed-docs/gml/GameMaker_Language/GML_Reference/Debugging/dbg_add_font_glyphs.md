...
| --- | --- | --- |
| filename | [String](../../GML_Overview/Data_Types.md) | The filename of the TTF file to use |
| size | [Real](../../GML_Overview/Data_Types.md) | The size of the font in pixels (default is 13\) |
| font\_range | [Real](../../GML_Overview/Data_Types.md) | The range of characters to add (default is \-1 for the Latin range) |
