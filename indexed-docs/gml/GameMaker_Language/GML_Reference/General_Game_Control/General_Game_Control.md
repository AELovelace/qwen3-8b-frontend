...
The following [global scope](../../GML_Overview/Variables/Global_Variables.md) **built\-in** variables are useful for debugging your game \- they can be used as the output to a log file in the case of issues, for example \- as well as for showing the current build ID, etc. to the user: 

- [game\_id](game_id.md)
- [game\_save\_id](game_save_id.md)
- [game\_display\_name](game_display_name.md)
- [game\_project\_name](game_project_name.md)
...
- [highscore\_name](highscore_name.md)
...
- [draw\_highscore](../Drawing/Text/draw_highscore.md)
