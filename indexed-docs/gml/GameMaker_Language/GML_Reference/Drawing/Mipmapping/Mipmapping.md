...
You can also enable [Anisotropic Filtering](gpu_set_tex_mip_filter.md) to make textures appear sharper.

The image below shows the difference mipmapping and anisotropic filtering can make when rendering your project:
...
- [gpu\_get\_tex\_mip\_filter\_ext](gpu_get_tex_mip_filter_ext.md)
...
- [gpu\_get\_tex\_max\_mip](gpu_get_tex_max_mip.md)
- [gpu\_get\_tex\_max\_mip\_ext](gpu_get_tex_max_mip_ext.md)
- [gpu\_get\_tex\_max\_aniso](gpu_get_tex_max_aniso.md)
- [gpu\_get\_tex\_max\_aniso\_ext](gpu_get_tex_max_aniso_ext.md)
...
- [gpu\_set\_tex\_mip\_bias](gpu_set_tex_mip_bias.md)
- [gpu\_set\_tex\_mip\_bias\_ext](gpu_set_tex_mip_bias_ext.md)
- [gpu\_set\_tex\_min\_mip](gpu_set_tex_min_mip.md)
...
- [gpu\_set\_tex\_max\_aniso](gpu_set_tex_max_aniso.md)
