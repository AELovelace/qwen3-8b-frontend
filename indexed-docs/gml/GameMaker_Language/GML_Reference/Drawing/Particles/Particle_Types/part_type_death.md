...
| death\_number | [Real](../../../../GML_Overview/Data_Types.md) | The quantity of the new particle to create at the particle death. If a negative value, it will instead create a fraction chance one is created (eg \-3 would mean that one is created every 3 or so steps). |
| death\_type | [Particle Type ID](part_type_create.md) | The index of the particle type to create at death. |
