...
Finally, you can set the "wiggle" factor. This is a value that will be added or subtracted randomly to the size each step of the particles lifetime. Obviously larger values are more pronounced than smaller ones, and this value can even be a negative with the maximum range being between \-20 and 20\.
  ...
  To change the size on the x and y axis separately you can use [part\_type\_size\_x](part_type_size_x.md) and [part\_type\_size\_y](part_type_size_y.md) instead.
...
| size\_min | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The minimum size the particle can start at. |
| size\_max | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The maximum size the particle can start at. |
| size\_incr | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | How much the particle should increase or decrease per step. |
| size\_wiggle | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | How much should randomly be added or subtracted from the particles size per step. |
