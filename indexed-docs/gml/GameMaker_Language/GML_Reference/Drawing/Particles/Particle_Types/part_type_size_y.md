...
| size\_min\_y | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The minimum size on the y axis that particles of this type can be created with |
| size\_max\_y | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The maximum size on the y axis that particles of this type can be created with |
| size\_incr\_y | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The size along the y axis to add every step |
| size\_wiggle\_y | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The "wiggle" value; the maximum random value that can be added every step |
