...
| speed\_min | [Real](../../../../GML_Overview/Data_Types.md) | The minimum speed the particle can start at. |
| speed\_max | [Real](../../../../GML_Overview/Data_Types.md) | The maximum speed the particle can start at. |
| speed\_incr | [Real](../../../../GML_Overview/Data_Types.md) | How much the particle speed should increase or decrease per step. |
| speed\_wiggle | [Real](../../../../GML_Overview/Data_Types.md) | How much should randomly be added or subtracted from the particle's speed per step. |
