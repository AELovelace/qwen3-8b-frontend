...
| step\_number | [Real](../../../../GML_Overview/Data_Types.md) | The quantity of the new particle to create per step. |
| step\_type | [Particle Type ID](part_type_create.md) | The index of the particle type to create per step. |
