...
This is as if you'd add the emitters inside that particle system asset to the given particle system and then call [part\_emitter\_burst](../Particle_Emitters/part_emitter_burst.md) on all of them.
  ...
  Particles won't be created for any disabled emitters in the [Particle System Asset](The_Asset_Editors/Particle_Systems.md) (which is **Enabled** unchecked).
...
| --- | --- | --- |
| ind | [Particle System Instance](GameMaker_Language/GML_Reference/Drawing/Particles/Particle_Systems/part_system_create.md) | The index of the particle system in which to create the particles |
| x | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The x position to burst the particles |
| y | [Real](GameMaker_Language/GML_Overview/Data_Types.md) | The y position to burst the particles |
| partsys | [Particle System Asset](The_Asset_Editors/Particle_Systems.md) | The particle system asset of which to burst particles |
