...
You can also choose to draw only *part* of the texture over the surface of the primitive by setting the appropriate xtex/ytex position to sample to (these coordinates are also known as the **UV** points). This point is defined by a value between 0 and 1, with the top\-left corner of the sprite image to use being the (0, 0\) point and the bottom\-right corner being the (1, 1\) point. In this way you can texture a primitive with only a part of the source image asset.
...
| --- | --- | --- |
| x | [Real](../../../GML_Overview/Data_Types.md) | The x coordinate of the vertex. |
| y | [Real](../../../GML_Overview/Data_Types.md) | The y coordinate of the vertex. |
| xtex | [Real](../../../GML_Overview/Data_Types.md) | The fraction of the width of the texture. 0 corresponds to the left side of the sprite on the texture page. 1 corresponds to the right side of the sprite on the texture page. |
| ytex | [Real](../../../GML_Overview/Data_Types.md) | The fraction of the height of the texture. 0 corresponds to the top side of the sprite on the texture page. 1 corresponds to the bottom side of the sprite on the texture page. |
