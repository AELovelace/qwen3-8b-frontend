...
| --- | --- | --- |
| equation | [Blend Mode Equation Constant](gpu_set_blendequation.md) | Blend mode equation used for RGB components |
| equation\_alpha | [Blend Mode Equation Constant](gpu_set_blendequation.md) | Blend mode equation used for the alpha component |
