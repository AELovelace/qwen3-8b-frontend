...
| tile\_index\_mask | A special constant that is for "and"\-ing with the tile data blob to extract the tile index. |
...
| --- | --- | --- |
| tileset | [Tile Set Asset](../../../../The_Asset_Editors/Tile_Sets.md) | The handle of the tile set to use |
| tiledata | [Tile Data](../../Asset_Management/Rooms/Tile_Map_Layers/tilemap_get.md) | The tile data to use |
| frame | [Real](../../../GML_Overview/Data_Types.md) | The frame number for the animated tile to use (default 0 for non\-animated tiles) |
| x | [Real](../../../GML_Overview/Data_Types.md) | The x position within the room to draw at |
| y | [Real](../../../GML_Overview/Data_Types.md) | The y position within the room to draw at |
