...
| c1 | [Colour](../Colour_And_Alpha/Colour_And_Alpha.md) | The colour with which to blend the top left area of the sprite. |
| c2 | [Colour](../Colour_And_Alpha/Colour_And_Alpha.md) | The colour with which to blend the top right area of the sprite. |
| c3 | [Colour](../Colour_And_Alpha/Colour_And_Alpha.md) | The colour with which to blend the bottom right area of the sprite. |
| c4 | [Colour](../Colour_And_Alpha/Colour_And_Alpha.md) | The colour with which to blend the bottom left area of the sprite. |
