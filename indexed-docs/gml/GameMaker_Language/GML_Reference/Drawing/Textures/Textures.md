...
- [Texture Pages](../../../../Settings/Texture_Information/Texture_Pages.md) created by GameMaker, which contain:
	- Sprites that you add to [Texture Groups](../../../../Settings/Texture_Groups.md) or place on a [Separate Texture Page](../../../../Settings/Texture_Information/Texture_Pages.md#h)
	- Font glyphs
...
- [draw\_texture\_flush](draw_texture_flush.md)
...
- [texture\_debug\_messages](texture_debug_messages.md)
...
- [texturegroup\_get\_fonts](texturegroup_get_fonts.md)
...
- [texturegroup\_add](texturegroup_add.md)
- [texturegroup\_delete](texturegroup_delete.md)
- [texturegroup\_exists](texturegroup_exists.md)
- [texturegroup\_set\_mode](texturegroup_set_mode.md)
