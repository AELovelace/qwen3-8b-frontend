...
| --- | --- | --- |
| user\_id | [Xbox User ID](xboxlive_get_user.md) | The user ID (a pointer) to get the gamer picture for |
| imagesize | [Real](../../../GML_Overview/Data_Types.md) | Size in pixels of the sprite to be returned |
| xorig | [Real](../../../GML_Overview/Data_Types.md) | Indicate the x position of the origin in the sprite |
| yorig | [Real](../../../GML_Overview/Data_Types.md) | Indicate the y position of the origin in the sprite |
