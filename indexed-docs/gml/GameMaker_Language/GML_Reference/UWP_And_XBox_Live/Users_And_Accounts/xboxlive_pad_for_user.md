...
| --- | --- | --- |
| user\_id | [Xbox User ID](xboxlive_get_user.md) | The User ID (a pointer) to check |
| slot | [Real](../../../GML_Overview/Data_Types.md) | The index (an integer) of the gamepad slot to check |
