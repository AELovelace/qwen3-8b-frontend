...
| --- | --- | --- |
| user\_id | [Xbox User ID](../../../../GameMaker_Language/GML_Reference/UWP_And_XBox_Live/Users_And_Accounts/xboxlive_get_user.md) | The User ID pointer to open the helpfile for. |
