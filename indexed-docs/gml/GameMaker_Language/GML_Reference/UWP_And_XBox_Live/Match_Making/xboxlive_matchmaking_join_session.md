...
| session\_handle |  | The "correlation id" to use for the session ID (see description, above) |
| sdatemplate |  | The name of the secure device association template to use |
