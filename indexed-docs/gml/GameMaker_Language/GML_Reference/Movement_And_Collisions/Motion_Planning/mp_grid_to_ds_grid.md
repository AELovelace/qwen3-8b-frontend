...
This function copies the given MP grid into a [DS grid](../../Data_Structures/DS_Grids/DS_Grids.md).

A cell in the DS grid will contain the value \-1 if it's flagged as occupied in the MP grid, or 0 if it isn't.

  To convert from MP grid to DS grid, see [ds\_grid\_to\_mp\_grid](../../Data_Structures/DS_Grids/ds_grid_to_mp_grid.md).
...
| --- | --- | --- |
| source | [MP Grid ID](mp_grid_create.md) | Index of the mp\_grid that is to be used |
| destination | [DS Grid](../../Data_Structures/DS_Grids/ds_grid_create.md) | The ds\_grid that is to be used to copy the grid data to. |
