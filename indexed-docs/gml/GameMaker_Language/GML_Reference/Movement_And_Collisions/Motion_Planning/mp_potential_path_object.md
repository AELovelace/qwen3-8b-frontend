...
| factor | [Real](../../../GML_Overview/Data_Types.md) | This number is used to prevent an infinite loop. It should be larger than 1\. See the function description for more information. |
| obj | [Object Asset](../../../../The_Asset_Editors/Objects.md) | The object that is to block the path. Can be an object index, an instance id or the special keyword ,**all** |
