...
| 3 | resultString \= "GameUploadSuccess" | data from [cloud\_string\_save()](cloud_string_save.md) or [cloud\_file\_save()](cloud_file_save.md) was successfully uploaded to the cloud |
