...
Note that this will return the *raw* value for the button, and does *not* take into account the setting for the threshold (see [here](gamepad_set_button_threshold.md) for more information on thresholds).
