...
| --- | --- | --- |
| device | [Real](../../../GML_Overview/Data_Types.md) | Which gamepad device "slot" to set. |
| option\_name | [String](../../../GML_Overview/Data_Types.md) | The name of the option to set (a string, see the table above) |
| value | [Real](../../../GML_Overview/Data_Types.md), [Boolean](../../../GML_Overview/Data_Types.md), or [String](../../../GML_Overview/Data_Types.md) | The value to set the option to (can be boolean, real or string \- see the table above) |
