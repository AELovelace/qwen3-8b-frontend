...
Note that there may be a slight delay between the user connecting the gamepad and GameMaker detecting it as being connected (this is especially the case when dealing with Bluetooth connected controllers).
  ...
  On some platforms \- especially consoles \- this function may return false immediately after a gamepad has been connected/selected. It is recommended to instead use the Async [System](../../../../The_Asset_Editors/Object_Properties/Async_Events/System.md) event to check when it's connected.
...
| --- | --- | --- |
| device | [Real](../../../GML_Overview/Data_Types.md) | The gamepad "slot" to check |
