...
- guid \- a string of digits and letters that uniquely identifies a device type (this can be retrieved using the [gamepad\_get\_guid()](gamepad_get_guid.md) function)
...
Here \ (i.e.: the direct gamepad input) can be any one of the following:

- a\ \- This represents an axis of the gamepad, where the \ is one of the axes from 0 to [gamepad\_axis\_count()](gamepad_axis_count.md) \-1
- b\ \- This represents a button of the gamepad, where the \ is one of the buttons from 0 to [gamepad\_button\_count()](gamepad_button_count.md) \-1
- h\.\ \- This represents a hat of the gamepad, where the \ represents a hat from 0 to [gamepad\_hat\_count()](gamepad_hat_count.md) \-1, and the \ will be either 1, 2, 4, or 8\.
...
| x | gp\_face3 |
| y | gp\_face4 |
| leftshoulder | gp\_shoulderl |
| lefttrigger | gp\_shoulderlb |
| rightshoulder | gp\_shoulderr |
| righttrigger | gp\_shoulderrb |
| guide | gp\_select |
| start | gp\_start |
| leftstick | gp\_stickl |
| rightstick | gp\_stickr |
| dpup | gp\_padu |
| dpdown | gp\_padl |
| dpleft | gp\_padr |
| dpright | gp\_padd |
...
| --- | --- | --- |
| index | [Real](../../../GML_Overview/Data_Types.md) | The gamepad index "slot" to set |
| mapping\_string | [String](../../../GML_Overview/Data_Types.md) | The map string to use (see the description for more information) |
