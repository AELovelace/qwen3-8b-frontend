...
| target | [String](../../GML_Overview/Data_Types.md) | This is the target area to open the URL in (see description). This is only used in HTML5\. |
| options | [String](../../GML_Overview/Data_Types.md) | Standard browser options (see description). This is only used in HTML5\. |
