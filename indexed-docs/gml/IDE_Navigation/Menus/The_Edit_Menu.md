...
- **Find \& Replace**: This contains the following options:
	...
	- **Replace In Editor**: Opens the same Find window in Replace mode. See: [Find \& Replace](../../The_Asset_Editors/Code_Editor_Properties/Editing_Text.md#h2)
...
Once you have given a search (and optionally a replace) term and set up the search options, you can use the different buttons at the bottom to choose how to perform the search and any actions to take. These buttons are:
...
All results from using the Search \& Replace window will be shown in the [Search Output Window](../../Introduction/The_Output_Window.md) at the bottom of the IDE. Each result can be  double\-clicked to open the asset with the term in the current workspace and pan to it, ready for editing.
