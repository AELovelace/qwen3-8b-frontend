...
The **Display Name** is what will be shown as the name for the package on Marketplace, and the **Package ID** is what will be used to identify the package from GameMaker and within the Marketplace publisher dashboard. The Package ID must be *unique* to the asset being uploaded, and should follow reverse URL format, eg: com.\.\.

Assets with a publisher ID that do *not* follow the above rule, may not upload correctly!
...
Finally you will be required to supply a number of images to properly market your assets on Marketplace. An icon (200×200 PNG) and a feature graphic (1140×360 PNG), then at least one screenshot (which should be PNG but can be authored with the following sizes: 1280×720, 1366×768, 1600×900 or 1920×1080\), and finally you have the option of adding in a video from either **YouTube** or **Vimeo**.
...
Note that setting up a Service Listing is slightly different to setting up an asset listing, and you can find full details from the following page:
